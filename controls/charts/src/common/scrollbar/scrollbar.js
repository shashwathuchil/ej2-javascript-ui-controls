define(["require", "exports", "@syncfusion/ej2-base", "./scrollbar-elements", "../utils/helper", "../model/theme", "../model/constants"], function (require, exports, ej2_base_1, scrollbar_elements_1, helper_1, theme_1, constants_1) {
    "use strict";
    ...
    var ScrollBar = (function () {
        function ScrollBar(component, axis) {
            ...
            this.elements = [];
            this.scrollElements = new scrollbar_elements_1.ScrollElements(component);
            this.axis = axis;
        ...
        ScrollBar.prototype.getMouseXY = function (e) {
            ...
            var svgRect = helper_1.getElement(this.component.element.id + '_scrollBar_svg' + this.axis.name).getBoundingClientRect();
        ...
        ScrollBar.prototype.wireEvents = function (element) {
            ej2_base_1.EventHandler.add(element, ej2_base_1.Browser.touchStartEvent, this.scrollMouseDown, this);
            ej2_base_1.EventHandler.add(element, ej2_base_1.Browser.touchMoveEvent, this.scrollMouseMove, this);
            ej2_base_1.EventHandler.add(element, ej2_base_1.Browser.touchEndEvent, this.scrollMouseUp, this);
            ej2_base_1.EventHandler.add(element, 'mousewheel', this.scrollMouseWheel, this);
        ...
        ScrollBar.prototype.unWireEvents = function (element) {
            ej2_base_1.EventHandler.remove(element, ej2_base_1.Browser.touchStartEvent, this.scrollMouseDown);
            ej2_base_1.EventHandler.remove(element, ej2_base_1.Browser.touchMoveEvent, this.scrollMouseMove);
            ej2_base_1.EventHandler.remove(element, ej2_base_1.Browser.touchEndEvent, this.scrollMouseUp);
            ej2_base_1.EventHandler.remove(element, 'mousewheel', this.scrollMouseWheel);
        ...
        ScrollBar.prototype.scrollMouseDown = function (e) {
            ...
            this.component.trigger(constants_1.scrollStart, this.getArgs(constants_1.scrollStart));
            if (this.isExist(id, 'scrollBarThumb_') || this.isExist(id, 'gripCircle')) {
                ...
                if (this.isLazyLoad) {
                    ...
                    if (args) {
                        this.component.trigger(constants_1.scrollEnd, args);
                    }
                }
            }
        ...
        ScrollBar.prototype.scrollMouseMove = function (e) {
            ...
            var elem = this.scrollElements;
            var isInverse = this.axis.isAxisInverse;
            if (!helper_1.getElement(this.svgObject.id)) {
                return null;
            }
            this.getMouseXY(e);
            ...
            if (this.isThumbDrag) {
                ...
                this.component.trigger(constants_1.scrollChanged, this.getArgs(constants_1.scrollChanged, range, zoomPosition, zoomFactor, currentRange));
            }
        ...
        ScrollBar.prototype.scrollMouseWheel = function (e) {
            ...
            var cumulative = Math.max(Math.max(1 / helper_1.minMax(axis.zoomFactor, 0, 1), 1) + (0.25 * direction), 1);
            var range = this.axis.visibleRange;
            var zoomPosition = this.zoomPosition;
            var zoomFactor = this.zoomFactor;
            var args;
            if (cumulative >= 1) {
                ...
                this.zoomFactor = (cumulative === 1) ? 1 : helper_1.minMax(1 / cumulative, 0, 1);
            ...
            if (!this.isLazyLoad) {
                this.component.trigger(constants_1.scrollChanged, this.getArgs(constants_1.scrollChanged, range, zoomPosition, zoomFactor));
            }
        };
        ScrollBar.prototype.scrollMouseUp = function () {
            ...
            if (this.scrollStarted && !this.isLazyLoad) {
                this.component.trigger(constants_1.scrollEnd, this.getArgs(constants_1.scrollChanged, this.startRange, this.startZoomPosition, this.startZoomFactor));
                this.scrollStarted = false;
            }
        ...
        ScrollBar.prototype.render = function (isScrollExist) {
            ...
            scrollbar_elements_1.createScrollSvg(this, this.component.svgRenderer);
        ...
        ScrollBar.prototype.getTheme = function () {
            this.scrollbarThemeStyle = theme_1.getScrollbarThemeColor(this.component.theme);
        };
        ScrollBar.prototype.removeScrollSvg = function () {
            if (document.getElementById(this.component.element.id + '_scrollBar_svg' + this.axis.name)) {
                ej2_base_1.remove(document.getElementById(this.component.element.id + '_scrollBar_svg' + this.axis.name));
            }
        };
        ...
        ScrollBar.prototype.getLogRange = function (axis) {
            var range = axis.scrollbarSettings.range;
            var start = helper_1.logBase(range.minimum, axis.logBase);
            var end = helper_1.logBase(range.maximum, axis.logBase);
        ...
        ScrollBar.prototype.destroy = function () {
            ...
            if (this.axes) {
                ...
                this.elements.map(function (element) {
                    ...
                    ej2_base_1.remove(element.firstChild);
                });
                this.elements = [];
            }
        };
