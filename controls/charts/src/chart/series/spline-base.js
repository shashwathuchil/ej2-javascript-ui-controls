...
define(["require", "exports", "../../common/utils/helper", "@syncfusion/ej2-base", "./line-base"], function (require, exports, helper_1, ej2_base_1, line_base_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var SplineBase = (function (_super) {
        ...
        SplineBase.prototype.filterEmptyPoints = function (series, seriesPoints) {
            ...
            var points = seriesPoints ? seriesPoints : ej2_base_1.extend([], series.points, null, true);
        ...
        SplineBase.prototype.getControlPoints = function (point1, point2, ySpline1, ySpline2, series) {
            ...
            switch (series.splineType) {
                case 'Cardinal':
                    ...
                    controlPoint1 = new helper_1.ChartLocation(xValue1 + ySpline1 / 3, yValue1 + ySplineDuplicate1 / 3);
                    controlPoint2 = new helper_1.ChartLocation(xValue2 - ySpline2 / 3, yValue2 - ySplineDuplicate2 / 3);
                    point = new helper_1.ControlPoints(controlPoint1, controlPoint2);
                    break;
                case 'Monotonic':
                    var value = (xValue2 - xValue1) / 3;
                    controlPoint1 = new helper_1.ChartLocation(xValue1 + value, yValue1 + ySpline1 * value);
                    controlPoint2 = new helper_1.ChartLocation(xValue2 - value, yValue2 - ySpline2 * value);
                    point = new helper_1.ControlPoints(controlPoint1, controlPoint2);
                    break;
                default:
                    var one3 = 1 / 3.0;
                    ...
                    controlPoint1 = new helper_1.ChartLocation((2 * (xValue1) + (xValue2)) * one3, y1);
                    controlPoint2 = new helper_1.ChartLocation(((xValue1) + 2 * (xValue2)) * one3, y2);
                    point = new helper_1.ControlPoints(controlPoint1, controlPoint2);
                    break;
            }
            return point;
