...
define(["require", "exports", "../../common/utils/helper", "../utils/double-range", "../../common/utils/helper", "@syncfusion/ej2-data", "../axis/axis-helper", "@syncfusion/ej2-base"], function (require, exports, helper_1, double_range_1, helper_2, ej2_data_1, axis_helper_1, ej2_base_1) {
    "use strict";
    ...
    var DateTime = (function (_super) {
        ...
        DateTime.prototype.getActualRange = function (axis, size) {
            ...
            if ((axis.minimum) !== null) {
                this.min = this.chart.isBlazor ? Date.parse(axis.minimum.toString()) : Date.parse(dateParser(dateFormatter(new Date(ej2_data_1.DataUtil.parse.parseJson({ val: axis.minimum }).val))));
            }
            else if (this.min === null || this.min === Number.POSITIVE_INFINITY) {
                this.min = Date.parse(dateParser(dateFormatter(new Date(1970, 1, 1))));
            }
            if ((axis.maximum) !== null) {
                this.max = this.chart.isBlazor ? Date.parse(axis.maximum.toString()) : Date.parse(dateParser(dateFormatter(new Date(ej2_data_1.DataUtil.parse.parseJson({ val: axis.maximum }).val))));
            }
        ...
        DateTime.prototype.calculateVisibleRange = function (size, axis) {
            ...
            if ((helper_1.isZoomSet(axis)) && !isLazyLoad) {
