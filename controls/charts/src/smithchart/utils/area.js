define(["require", "exports", "../../smithchart/utils/helper"], function (require, exports, helper_1) {
    "use strict";
    ...
    var AreaBounds = (function () {
        ...
        AreaBounds.prototype.getLegendSpace = function (smithchart, bounds) {
            ...
            if (legend['visible']) {
                ...
                ltheight = legend['title'].visible ? helper_1.measureText(legend['title'].text, font)['height'] : 0;
            ...
            subtitleHeight = helper_1.measureText(title.subtitle.text, font)['height'];
