define(["require", "exports", "../../smithchart/utils/helper", "../../smithchart/utils/utils", "../../smithchart/utils/utils", "../../smithchart/utils/helper", "../model/constant"], function (require, exports, helper_1, utils_1, utils_2, helper_2, constant_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var AxisRender = (function () {
        function AxisRender() {
            ...
            this.direction = new utils_1.Direction();
        }
        ...
        AxisRender.prototype.maximumLabelLength = function (smithchart) {
            ...
            for (var i = 0; i < this.radialLabels.length; i++) {
                ...
                textSize = helper_1.measureText(label, font);
        ...
        AxisRender.prototype.measureHMajorGridLines = function (smithchart) {
            ...
            for (var i = 0; i < this.horizontalLabelCollections.length; i++) {
                var circlePoint = new utils_1.HorizontalLabelCollection();
        ...
        AxisRender.prototype.updateHMajorGridLines = function (smithchart) {
            ...
            var haxismgoptions = new helper_2.PathOption(smithchart.element.id + '_horizontalAxisMajorGridLines', 'none', majorGridLine['width'], majorGridLine.color ? majorGridLine.color : smithchart.themeStyle.majorGridLine, majorGridLine['opacity'], majorGridLine['dashArray'], path);
        ...
        AxisRender.prototype.updateRMajorGridLines = function (smithchart) {
            ...
            var raxismgoptions = new helper_2.PathOption(smithchart.element.id + '_radialAxisMajorGridLines', 'none', majorGridLine['width'], majorGridLine.color ? majorGridLine.color : smithchart.themeStyle.majorGridLine, majorGridLine['opacity'], majorGridLine['dashArray'], path);
        ...
        AxisRender.prototype.updateHAxisLine = function (smithchart) {
            ...
            var options = new helper_2.PathOption(smithchart.element.id + '_horizontalAxisLine', 'none', axisLine.width, axisLine.color ? axisLine.color : smithchart.themeStyle.axisLine, 1, axisLine.dashArray, direction);
        ...
        AxisRender.prototype.updateRAxisLine = function (smithchart) {
            ...
            var direction = 'M' + ' ' + point1.x + ' ' + point1.y + ' ' + 'A' + ' ' +
                ...
                point2.x + ' ' + point2.y + '';
            var options = new helper_2.PathOption(smithchart.element.id + '_radialAxisLine', 'none', axisLine.width, axisLine.color ? axisLine.color : smithchart.themeStyle.axisLine, 1, axisLine.dashArray, direction);
            ...
            var _loop_1 = function (i) {
                ...
                if (circleAxis.value !== 0.0) {
                    ...
                    var axisLabelRenderEventArgs_1 = {
                        ...
                        x: x,
                        y: y,
                        name: constant_1.axisLabelRender,
                        cancel: false
                    };
                    var axisLabelRenderSuccess = function (args) {
                        if (!args.cancel) {
                            var options = new helper_2.TextOption(smithchart.element.id + '_HLabel_' + i, axisLabelRenderEventArgs_1.x, axisLabelRenderEventArgs_1.y, 'none', axisLabelRenderEventArgs_1.text);
                            ...
                            var element = helper_2.renderTextElement(options, font, color, groupEle);
                            groupEle.appendChild(element);
                        }
                    };
                    axisLabelRenderSuccess.bind(this_1);
                    smithchart.trigger(constant_1.axisLabelRender, axisLabelRenderEventArgs_1, axisLabelRenderSuccess);
                }
            };
            var this_1 = this;
            for (var i = 0; i < this.horizontalLabelCollections.length; i++) {
        ...
        AxisRender.prototype.drawRAxisLabels = function (smithchart) {
            ...
            var interSectPoint = new utils_2.RadialLabelCollections();
            var label;
            var textSize;
            var angle;
            var position;
            ...
            var _loop_2 = function (i) {
                ...
                var axisLabelRenderSuccess = function (args) {
                    if (!args.cancel) {
                        var options = new helper_2.TextOption(smithchart.element.id + '_RLabel_' + i, axisLabelRenderEventArgs.x, axisLabelRenderEventArgs.y, 'none', axisLabelRenderEventArgs.text);
                        var color = font.color ? font.color : smithchart.themeStyle.axisLabel;
                ...
                smithchart.trigger(constant_1.axisLabelRender, axisLabelRenderEventArgs, axisLabelRenderSuccess);
            };
            var this_2 = this;
        ...
        AxisRender.prototype.calculateRegion = function (label, textSize, textPositionX, textPositionY) {
            var xAxisLabelRegions = new utils_1.LabelRegion();
        ...
        AxisRender.prototype.updateHMinorGridLines = function (smithchart) {
            ...
            var haxismioptions = new helper_2.PathOption(smithchart.element.id + '_horizontalAxisMinorGridLines', 'none', minorGridLine['width'], minorGridLine.color ? minorGridLine.color : smithchart.themeStyle.minorGridLine, minorGridLine['opacity'], minorGridLine['dashArray'], path);
        ...
        AxisRender.prototype.updateRMinorGridLines = function (smithchart) {
            ...
            var raxismioptions = new helper_2.PathOption(smithchart.element.id + '_radialAxisMinorGridLines', 'none', minorGridLine['width'], minorGridLine.color ? minorGridLine.color : smithchart.themeStyle.minorGridLine, minorGridLine['opacity'], minorGridLine['dashArray'], path);
        ...
        AxisRender.prototype.calculateGridLinesPath = function (points) {
            ...
            var r1;
            var r2;
            var pathSegment = new utils_2.GridArcPoints();
            var angle;
            var isLargeArc;
            var sweep;
            var sb = '';
