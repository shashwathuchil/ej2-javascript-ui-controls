define(["require", "exports", "../../smithchart/utils/helper", "../../smithchart/utils/utils", "../model/constant"], function (require, exports, helper_1, utils_1, constant_1) {
    ...
    var SmithchartLegend = (function () {
        ...
        SmithchartLegend.prototype.calculateLegendBounds = function (smithchart) {
            ...
            var titleSize = helper_1.measureText(smithchart.legendSettings['title']['text'], font);
            var maxRowWidth = 0;
        ...
        SmithchartLegend.prototype._getLegendSize = function (smithchart, series) {
            ...
            var textSize = helper_1.measureText(series.text, legend.textStyle);
        ...
        SmithchartLegend.prototype._drawLegend = function (smithchart) {
            ...
            var smithchartTitleHeight = helper_1.measureText(smithchart.title.text, titleFont).height;
            var smithchartSubtitleHeight = helper_1.measureText(smithchart.title.subtitle.text, smithchart.title.subtitle.textStyle).height;
            ...
            var legendWidth = 0;
            var titleSize = helper_1.measureText(legend['title']['text'], legend.title.textStyle);
        ...
        SmithchartLegend.prototype.drawLegendTitle = function (smithchart, legend, legendBounds, gLegendEle) {
            ...
            var element = helper_1.renderTextElement(options, legend.title.textStyle, smithchart.themeStyle.legendLabel, gLegendEle);
        ...
        SmithchartLegend.prototype.drawLegendItem = function (smithchart, legend, legendSeries, k, x, y, legendBounds) {
            ...
            textHeight = helper_1.measureText(legendSeries['text'], legend.textStyle).height;
            location = {
                x: x + symbol['width'] / 2,
            ...
            var legendRenderSuccess = function (args) {
                if (!args.cancel) {
                    ...
                    var element = helper_1.renderTextElement(options, legend.textStyle, smithchart.themeStyle.legendLabel, legendGroup);
