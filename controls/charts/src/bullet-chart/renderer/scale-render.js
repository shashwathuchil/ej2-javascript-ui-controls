define(["require", "exports", "@syncfusion/ej2-base", "@syncfusion/ej2-svg-base", "../../common/utils/helper", "@syncfusion/ej2-base", "../../common/utils/helper"], function (require, exports, ej2_base_1, ej2_svg_base_1, helper_1, ej2_base_2, helper_2) {
    ...
    var ScaleGroup = (function () {
            ...
            for (var i = 0; i < dataCount; i++) {
                ...
                if (bounds) {
                    ...
                    if (!ej2_base_1.isNullOrUndefined(categoryValue)) {
                        var categoryTextSize = ej2_svg_base_1.measureText(categoryValue, bulletChart.categoryLabelStyle);
                        ...
                        ej2_svg_base_1.textElement(categoryOptions, bulletChart.categoryLabelStyle, bulletChart.categoryLabelStyle.color || bulletChart.themeStyle.categoryFontColor, this.scaleSettingsGroup);
                    }
                }
        ...
        ScaleGroup.prototype.featureBar = function (pointX, pointY, width, i) {
            var featureBarOptions = new helper_1.RectOption(this.bulletChart.svgObject.id + '_FeatureMeasure_' + i, this.bulletChart.valueFill, this.bulletChart.valueBorder, 1, new ej2_svg_base_1.Rect(pointX, pointY, width, this.bulletChart.valueHeight));
        ...
        ScaleGroup.prototype.verticalFeatureBar = function (pointX, pointY, width, i) {
            var featureBarOptions = new helper_1.RectOption(this.bulletChart.svgObject.id + '_FeatureMeasure_' + i, this.bulletChart.valueFill, this.bulletChart.valueBorder, 1, new ej2_svg_base_1.Rect(pointX, pointY, this.bulletChart.valueHeight, width));
            var svgRect = this.bulletChart.renderer.drawRectangle(featureBarOptions);
            svgRect.setAttribute('class', this.bulletChart.svgObject.id + '_FeatureMeasure');
            svgRect.id = this.bulletChart.svgObject.id + '_FeatureMeasure_' + i;
            return svgRect;
        ...
        ScaleGroup.prototype.getTargetElement = function (targetType, isHorizontal, x1, y1, y2, value, k) {
            ...
            if (targetType === 'Rect') {
                ...
                shapeObject = new helper_1.CircleOption(id, bulletChart.targetColor, { width: 1, color: bulletChart.targetColor || 'black' }, 1, lx, ly, size);
                ...
                shapeObject = new ej2_svg_base_1.PathOption(id, 'transparent', strokeWidth, bulletChart.targetColor, 1, '', crossDirection);
        ...
        ScaleGroup.prototype.calculateFeatureMeasureBounds = function (value, categoryValue, isHorizontal) {
            ...
            if (value >= min) {
                ...
                var stringLength = ej2_svg_base_1.measureText(categoryValue.toString(), bulletChart.labelStyle).width;
