define(["require", "exports", "../../common/utils/helper", "@syncfusion/ej2-splitbuttons", "@syncfusion/ej2-buttons", "@syncfusion/ej2-svg-base", "@syncfusion/ej2-base"], function (require, exports, helper_1, ej2_splitbuttons_1, ej2_buttons_1, ej2_svg_base_1, ej2_base_1) {
    "use strict";
    ...
    var ToolBarSelector = (function () {
        ...
        ToolBarSelector.prototype.resetButton = function () {
            ...
            var reset = new ej2_buttons_1.Button();
        ...
        ToolBarSelector.prototype.printButton = function () {
            ...
            if (this.stockChart.exportType.indexOf('Print') > -1) {
                var print_1 = new ej2_buttons_1.Button();
            ...
            var exportChart = new ej2_splitbuttons_1.DropDownButton({
                ...
                select: function (args) {
                    ...
                    if (stockChart.chart.exportModule) {
                        ...
                        helper_1.getElement(stockID + 'chart').style.transform = 'translateY(0px)';
                        if (stockChart.enableSelector) {
        ...
        ToolBarSelector.prototype.addExportSettings = function () {
            ...
            var titleHeight = ej2_svg_base_1.measureText(this.stockChart.title, this.stockChart.titleStyle).height;
            ...
            helper_1.textElement(this.stockChart.renderer, options, this.stockChart.titleStyle, this.stockChart.titleStyle.color, exportElement);
            ...
            var y = titleHeight;
            this.textElementSpan(new ej2_svg_base_1.TextOption(exportElement.id + '_Series', x, y, 'start', ['Series : ', this.selectedSeries], '', 'text-before-edge'), style, 'black', exportElement);
            x += ej2_svg_base_1.measureText('Series: ' + this.selectedSeries + ' Z', style).width;
            if (this.selectedIndicator !== '') {
                this.textElementSpan(new ej2_svg_base_1.TextOption(exportElement.id + '_Indicator', x, y, 'start', ['Indicator :', this.selectedIndicator], '', 'text-before-edge'), style, 'black', exportElement);
                x += ej2_svg_base_1.measureText('Indicator: ' + this.selectedIndicator + ' Z', style).width;
            }
            if (this.selectedTrendLine !== '') {
                this.textElementSpan(new ej2_svg_base_1.TextOption(exportElement.id + '_TrendLine', x, y, 'start', ['Trendline :', this.selectedTrendLine], '', 'text-before-edge'), style, 'black', exportElement);
            }
