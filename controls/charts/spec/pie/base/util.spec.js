define(["require", "exports", "../../../src/common/utils/helper"], function (require, exports, helper_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function getPosition(element) {
        return new helper_1.ChartLocation(parseInt(element.style.left, 10), parseInt(element.style.top, 10));
    }
    exports.getPosition = getPosition;
    function getLocations(path) {
        var slice = path.split(' ');
        return {
            center: new helper_1.ChartLocation(+slice[1], +slice[2]),
            start: new helper_1.ChartLocation(+slice[4], +slice[5]),
            end: new helper_1.ChartLocation(+slice[12], +slice[13])
        };
    }
    exports.getLocations = getLocations;
    function addTooltipStyles() {
        var css = '.e-popup { height: auto; position: absolute; width: auto; z-index: 1000;}'
    ...
    exports.addTooltipStyles = addTooltipStyles;
});
