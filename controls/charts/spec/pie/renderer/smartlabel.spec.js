define(["require", "exports", "../../../src/index", "@syncfusion/ej2-base", "@syncfusion/ej2-svg-base"], function (require, exports, index_1, ej2_base_1, ej2_svg_base_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    index_1.AccumulationChart.Inject(index_1.AccumulationDataLabel, index_1.AccumulationLegend);
    describe('Pie Series smart label placing', function () {
        var pieElement;
        var testElement;
        var pieChart;
        beforeAll(function () {
            pieElement = ej2_base_1.createElement('div', { id: 'piesmart' });
            document.body.appendChild(pieElement);
            pieChart = new index_1.AccumulationChart({
        ...
        afterAll(function () {
            pieChart.destroy();
            ej2_svg_base_1.removeElement('piesmart');
        });
        it('Points in left side', function (done) {
            pieChart.loaded = function (args) {
        ...
        it('Points in right side', function (done) {
            pieChart.loaded = function (args) {
                testElement = document.getElementById('piesmart_datalabel_Series_0');
                expect(testElement).not.toBe(null);
                done();
        ...
        it('Default datalabel position inside', function (done) {
            pieChart.loaded = function (args) {
                testElement = document.getElementById('piesmart_datalabel_Series_0');
                expect(testElement).not.toBe(null);
                done();
        ...
        it('Default rendering', function (done) {
            pieChart.loaded = function (args) {
                testElement = document.getElementById('piesmart_datalabel_Series_0');
                expect(testElement).not.toBe(null);
                done();
        ...
        it('changing position to outside', function (done) {
            pieChart.loaded = function (args) {
                testElement = document.getElementById('piesmart_datalabel_Series_0');
                expect(testElement).not.toBe(null);
                done();
        ...
        it('changing position to in angle 150', function (done) {
            pieChart.loaded = function (args) {
                testElement = document.getElementById('piesmart_datalabel_Series_0');
                expect(testElement).not.toBe(null);
                done();
        ...
        it('changing position to in angle 300', function (done) {
            pieChart.loaded = function (args) {
                testElement = document.getElementById('piesmart_datalabel_Series_0');
                expect(testElement).not.toBe(null);
                done();
        ...
        it('checking with label skipping', function (done) {
            pieChart.loaded = function (args) {
                testElement = document.getElementById('piesmart_datalabel_Series_0');
                expect(testElement).not.toBe(null);
                done();
