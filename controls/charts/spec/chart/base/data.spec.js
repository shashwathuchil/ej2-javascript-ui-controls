define(["require", "exports", "@syncfusion/ej2-base"], function (require, exports, ej2_base_1) {
    ...
    exports.indexedCategoryData = [{ x: 'Monday', y: 50 }, { x: 'Tuesday', y: 40 },
        { x: 'Wednesday', y: 70 },
        { x: 'Thursday', y: 60 }, { x: 'Friday', y: 50 },
        { x: 'Monday', y: 40 }, { x: 'Monday', y: 30 }];
    exports.bar = [{ x: 1000, y: 70 }, { x: 2000, y: 40 },
        { x: 3000, y: 70 }, { x: 4000, y: 60 },
        { x: 5000, y: 50 }, { x: 6000, y: 40 },
        { x: 7000, y: 40 }, { x: 8000, y: 70 }];
    exports.barData = [{ x: 1000, y: 73 }, { x: 2000, y: 40 },
    ...
    exports.rotateData1 = [{ x: new Date(2000, 6, 11), y: 10 }, { x: new Date(2002, 3, 7), y: -30 },
        { x: new Date(2004, 3, 6), y: 15 }, { x: new Date(2006, 3, 30), y: -65 },
        { x: new Date(2008, 3, 8), y: 0 }, { x: new Date(2010, 3, 8), y: 85 }];
    exports.rotateData2 = [{ x: new Date(2000, 6, 11), y: -30 }, { x: new Date(2002, 3, 7), y: 10 },
    ...
    exports.rotatedLabels = [{ x: "Alfreds FutterkisteObere Str. 57", y: 29.46, size: null, fill: null },
