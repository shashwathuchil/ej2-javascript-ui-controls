define(["require", "exports", "@syncfusion/ej2-base", "../../../src/chart/chart", "../../../src/chart/legend/legend", "../../../src/chart/series/line-series", "../../../src/chart/series/candle-series", "../../../src/chart/technical-indicators/atr-indicator", "../../../src/chart/user-interaction/tooltip", "../../../src/chart/user-interaction/crosshair", "../base/events.spec", "../../../src/chart/axis/category-axis", "../../../src/chart/user-interaction/zooming", "../../common.spec"], function (require, exports, ej2_base_1, chart_1, legend_1, line_series_1, candle_series_1, atr_indicator_1, tooltip_1, crosshair_1, events_spec_1, category_axis_1, zooming_1, common_spec_1) {
    "use strict";
    var _this = this;
    Object.defineProperty(exports, "__esModule", { value: true });
    chart_1.Chart.Inject(zooming_1.Zoom, legend_1.Legend, line_series_1.LineSeries, candle_series_1.CandleSeries, category_axis_1.Category, atr_indicator_1.AtrIndicator, tooltip_1.Tooltip, crosshair_1.Crosshair);
    ...
    describe('Chart', function () {
        ...
        var element;
        describe('ATR Technical Indicators', function () {
            var chartObj;
            var loaded;
            ...
            it('ATR Technical Indicators without series', function (done) {
            ...
            it('ATR Technical indicator for a series with 0 points', function (done) {
                loaded = function (args) {
            ...
            it('ATR Technical Indicator for a series with 1 point', function (done) {
                loaded = function (args) {
                    var indicator = document.getElementById('containerIndicatorGroup0');
                    expect(indicator != null).toBe(true);
                    expect(indicator.childNodes.length).toBe(2);
            ...
            it('ATR Technical indicator for a series with valid points & primary axis', function (done) {
                loaded = function (args) {
                    var signalLine = document.getElementById('container_Indicator_0_ATR');
            ...
            it('ATR Technical indicator for a series with negative points', function (done) {
                loaded = function (args) {
            ...
            it('ATR Technical indicator for a series with secondary y axis', function (done) {
                loaded = function (args) {
            ...
            it('ATR Technical indicator with hidden series', function (done) {
                loaded = function (args) {
                    var signalLine = document.getElementById('container_Indicator_0_ATR');
                    expect(signalLine.getAttribute('d')).not.toBeNull();
                    done();
            ...
            it('ATR Technical indicator with opposed position', function (done) {
                loaded = function (args) {
                    var signalLine = document.getElementById('container_Indicator_0_ATR');
                    expect(signalLine.getAttribute('d')).not.toBeNull();
            ...
            it('ATR Technical indicator with secondary axis and plot offset', function (done) {
                loaded = function (args) {
                    var signalLine = document.getElementById('container_Indicator_0_ATR');
                    expect(signalLine.getAttribute('d')).not.toBeNull();
                    var point = document.getElementById('container_Indicator_0_ATR');
                    expect(point != null).toBe(true);
            ...
            it('ATR Technical indicator with default appearance', function (done) {
                loaded = function (args) {
                    var signalLine = document.getElementById('container_Indicator_0_ATR');
            ...
            it('ATR Technical indicator with custom color', function (done) {
                loaded = function (args) {
                    var signalLine = document.getElementById('container_Indicator_0_ATR');
            ...
            it('ATR Technical indicator with custom stroke style', function (done) {
                loaded = function (args) {
                    var signalLine = document.getElementById('container_Indicator_0_ATR');
            ...
            it('ATR Technical indicator with tooltip', function (done) {
                loaded = function (args) {
            ...
            it('ATR Technical indicator with cross hair', function (done) {
                loaded = function (args) {
                    var chartArea = document.getElementById('container_ChartAreaBorder');
                    var series = chartObj.series[0];
            ...
            it('ATR Technical indicator with track ball', function (done) {
                loaded = function (args) {
                    var tooltip;
                    var target = document.getElementById('container_Series_0_Point_1');
                    var series = chartObj.series[0];
            ...
            it('ATR Technical indicator when resizing the chart', function (done) {
                loaded = function (args) {
            ...
            it('ATR Technical indicator with default period', function (done) {
                loaded = function (args) {
                    var signalLine = document.getElementById('container_Indicator_0_ATR');
                    expect(signalLine.getAttribute('d')).not.toBeNull();
                    expect(chartObj.visibleSeries[1].points[0].x).toBe('Mar');
            ...
            it('ATR Technical indicator with custom period', function (done) {
                loaded = function (args) {
                    var signalLine = document.getElementById('container_Indicator_0_ATR');
                    expect(signalLine.getAttribute('d')).not.toBeNull();
            ...
            it('ATR Technical indicator using panels', function (done) {
                loaded = function (args) {
                    var element = document.getElementById('container_Indicator_0_ATR');
                    var rect;
