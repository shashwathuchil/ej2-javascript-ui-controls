define(["require", "exports", "@syncfusion/ej2-base", "../../../src/chart/chart", "../../../src/chart/legend/legend", "../../../src/chart/series/line-series", "../../../src/chart/series/candle-series", "../../../src/chart/technical-indicators/sma-indicator", "../../../src/chart/user-interaction/tooltip", "../../../src/chart/user-interaction/crosshair", "../base/events.spec", "../../../src/chart/axis/category-axis", "../../../src/chart/user-interaction/zooming", "../../common.spec"], function (require, exports, ej2_base_1, chart_1, legend_1, line_series_1, candle_series_1, sma_indicator_1, tooltip_1, crosshair_1, events_spec_1, category_axis_1, zooming_1, common_spec_1) {
    "use strict";
    var _this = this;
    Object.defineProperty(exports, "__esModule", { value: true });
    chart_1.Chart.Inject(zooming_1.Zoom, legend_1.Legend, sma_indicator_1.SmaIndicator, line_series_1.LineSeries, candle_series_1.CandleSeries, category_axis_1.Category, tooltip_1.Tooltip, crosshair_1.Crosshair);
    ...
    describe('Chart', function () {
        ...
        var element;
        describe('SMA Technical Indicators', function () {
            var chartObj;
            var loaded;
            ...
            it('SMA Technical Indicators without series', function (done) {
            ...
            it('SMA Technical indicator for a series with 0 points', function (done) {
                loaded = function (args) {
            ...
            it('SMA Technical Indicator for a series with 1 point', function (done) {
                loaded = function (args) {
                    var indicator = document.getElementById('containerIndicatorGroup0');
                    expect(indicator != null).toBe(true);
                    expect(indicator.childNodes.length).toBe(2);
            ...
            it('SMA Technical indicator for a series with valid points & primary axis', function (done) {
                loaded = function (args) {
            ...
            it('SMA Technical indicator for a series with negative points', function (done) {
                loaded = function (args) {
            ...
            it('SMA Technical indicator for a series with secondary y axis', function (done) {
                loaded = function (args) {
            ...
            it('SMA Technical indicator with hidden series', function (done) {
                loaded = function (args) {
                    var signalLine = document.getElementById('container_Indicator_0_SMA');
                    expect(signalLine.getAttribute('d')).not.toBeNull();
                    done();
            ...
            it('SMA Technical indicator with opposed position', function (done) {
                loaded = function (args) {
                    var signalLine = document.getElementById('container_Indicator_0_SMA');
                    expect(signalLine.getAttribute('d')).not.toBeNull();
            ...
            it('SMA Technical indicator with secondary axis and plot offset', function (done) {
                loaded = function (args) {
                    var signalLine = document.getElementById('container_Indicator_0_SMA');
                    expect(signalLine.getAttribute('d')).not.toBeNull();
            ...
            it('SMA Technical indicator with default appearance', function (done) {
                loaded = function (args) {
                    var signalLine = document.getElementById('container_Indicator_0_SMA');
            ...
            it('SMA Technical indicator with custom color', function (done) {
                loaded = function (args) {
                    var signalLine = document.getElementById('container_Indicator_0_SMA');
            ...
            it('SMA Technical indicator with custom stroke style', function (done) {
                loaded = function (args) {
                    var signalLine = document.getElementById('container_Indicator_0_SMA');
            ...
            it('SMA Technical indicator with tooltip', function (done) {
                loaded = function (args) {
            ...
            it('SMA Technical indicator with cross hair', function (done) {
                loaded = function (args) {
                    var chartArea = document.getElementById('container_ChartAreaBorder');
                    var series = chartObj.series[0];
            ...
            it('SMA Technical indicator with track ball', function (done) {
                loaded = function (args) {
                    var tooltip;
                    var target = document.getElementById('container_Series_0_Point_1');
                    var series = chartObj.series[0];
            ...
            it('SMA Technical indicator when resizing the chart', function (done) {
                loaded = function (args) {
            ...
            it('SMA Technical indicator with default period', function (done) {
                loaded = function (args) {
                    var signalLine = document.getElementById('container_Indicator_0_SMA');
                    expect(signalLine.getAttribute('d')).not.toBeNull();
                    expect(chartObj.visibleSeries[1].points[0].x).toBe('Mar');
            ...
            it('SMA Technical indicator with custom period', function (done) {
                loaded = function (args) {
                    var signalLine = document.getElementById('container_Indicator_0_SMA');
                    expect(signalLine.getAttribute('d')).not.toBeNull();
            ...
            it('SMA Technical indicator using panels', function (done) {
                loaded = function (args) {
