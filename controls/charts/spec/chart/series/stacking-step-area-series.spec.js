define(["require", "exports", "@syncfusion/ej2-base", "../../../src/chart/chart", "../../../src/chart/series/stacking-step-area-series", "../../../src/chart/legend/legend", "../../../src/chart/axis/category-axis", "../../../src/chart/axis/date-time-axis", "../../../src/chart/axis/logarithmic-axis", "../../../src/chart/series/data-label", "../base/data.spec", "../base/data.spec", "../base/events.spec", "../../../src/chart/user-interaction/data-editing", "../../../src/chart/user-interaction/tooltip", "../../../src/chart/user-interaction/crosshair", "../../common.spec", "../../../node_modules/es6-promise/dist/es6-promise"], function (require, exports, ej2_base_1, chart_1, stacking_step_area_series_1, legend_1, category_axis_1, date_time_axis_1, logarithmic_axis_1, data_label_1, data_spec_1, data_spec_2, events_spec_1, data_editing_1, tooltip_1, crosshair_1, common_spec_1) {
    "use strict";
    var _this = this;
    Object.defineProperty(exports, "__esModule", { value: true });
    chart_1.Chart.Inject(stacking_step_area_series_1.StackingStepAreaSeries, category_axis_1.Category, data_editing_1.DataEditing, legend_1.Legend, date_time_axis_1.DateTime, tooltip_1.Tooltip, logarithmic_axis_1.Logarithmic, data_label_1.DataLabel, legend_1.Legend, crosshair_1.Crosshair);
    ...
    describe('Chart Control', function () {
        ...
        var elem;
        describe('Chart Stacking Steparea series', function () {
            var chartObj;
            var svg;
            var marker;
            var targetElement;
        ...
        describe('Stacking Step Area Series Inversed axis', function () {
            var chart;
            var loaded;
            var element;
            var dataLabelY;
        ...
        describe('checking rotated step area chart', function () {
            ...
            beforeAll(function () {
                ...
                chart = new chart_1.Chart({
                    ...
                    series: [
                        { type: 'StackingStepArea', name: 'series1', dataSource: data_spec_2.rotateData1, xName: 'x', yName: 'y', animation: { enable: false },
                            marker: { visible: true } },
                        { type: 'StackingStepArea', name: 'series2', dataSource: data_spec_2.rotateData2, xName: 'x', yName: 'y', animation: { enable: false },
                            marker: { visible: true } }
                    ],
