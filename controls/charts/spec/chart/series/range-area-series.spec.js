define(["require", "exports", "@syncfusion/ej2-base", "../../../src/chart/chart", "../../../src/chart/legend/legend", "../../../src/chart/series/line-series", "../../../src/chart/series/data-label", "../../../src/chart/axis/category-axis", "../../../src/chart/axis/date-time-axis", "../../../src/chart/axis/logarithmic-axis", "../../../src/chart/series/range-area-series", "../../../src/chart/series/range-column-series", "../base/events.spec", "../../../src/chart/user-interaction/tooltip", "../../../src/chart/user-interaction/crosshair", "../../../src/chart/user-interaction/selection", "../base/data.spec", "../../common.spec", "../../../node_modules/es6-promise/dist/es6-promise"], function (require, exports, ej2_base_1, chart_1, legend_1, line_series_1, data_label_1, category_axis_1, date_time_axis_1, logarithmic_axis_1, range_area_series_1, range_column_series_1, events_spec_1, tooltip_1, crosshair_1, selection_1, data_spec_1, common_spec_1) {
    "use strict";
    var _this = this;
    Object.defineProperty(exports, "__esModule", { value: true });
    chart_1.Chart.Inject(line_series_1.LineSeries, data_label_1.DataLabel, category_axis_1.Category, date_time_axis_1.DateTime, range_area_series_1.RangeAreaSeries, range_column_series_1.RangeColumnSeries, legend_1.Legend, tooltip_1.Tooltip, crosshair_1.Crosshair, logarithmic_axis_1.Logarithmic, selection_1.Selection);
    var pointData = [
    ...
    describe('Chart', function () {
        ...
        describe('Range Area Series', function () {
            var chartObj;
            var loaded;
            var animate;
            ...
            it('Changing position', function (done) {
                loaded = function (args) {
                    var series1 = document.getElementById('container_Series_0_Point_3_Symbol');
            ...
            beforeAll(function () {
                ...
                chartObj = new chart_1.Chart({
                    ...
                    series: [{
                        ...
                        {
                            dataSource: exports.doubleData, xName: 'x', low: 'low', high: 'high', animation: { enable: false }, type: 'RangeArea',
        ...
        describe('Inversed Range Area Series', function () {
            var chartObj;
            var loaded;
            var animate;
            var trigger = new events_spec_1.MouseEvents();
            ...
            it('Checking inversed range area series', function (done) {
                loaded = function (args) {
                    var svg = document.getElementById('container_Series_0');
            ...
            it('Checking transposed range area series', function (done) {
                loaded = function (args) {
                    var svg = document.getElementById('container_Series_0');
                    var bounds = svg.getBoundingClientRect();
            ...
            it('Checking inversed & transposed range area series', function (done) {
                loaded = function (args) {
                    var svg = document.getElementById('container_Series_0');
                    var bounds = svg.getBoundingClientRect();
                    expect(bounds.top == 50.25 || bounds.top == 53.25).toBe(true);
