define(["require", "exports", "@syncfusion/ej2-base", "../../../src/chart/chart", "../../../src/chart/series/line-series", "../../../src/chart/series/area-series", "../../../src/chart/series/column-series", "../../../src/chart/series/bar-series", "../../../src/chart/axis/logarithmic-axis", "../../../src/chart/axis/date-time-axis", "../../../src/chart/axis/category-axis", "../../../src/chart/axis/multi-level-labels", "../../../src/chart/legend/legend", "../base/data.spec", "../../common.spec", "../base/events.spec", "@syncfusion/ej2-base", "../../../node_modules/es6-promise/dist/es6-promise"], function (require, exports, ej2_base_1, chart_1, line_series_1, area_series_1, column_series_1, bar_series_1, logarithmic_axis_1, date_time_axis_1, category_axis_1, multi_level_labels_1, legend_1, data_spec_1, common_spec_1, events_spec_1, ej2_base_2) {
    "use strict";
    var _this = this;
    Object.defineProperty(exports, "__esModule", { value: true });
    chart_1.Chart.Inject(line_series_1.LineSeries, logarithmic_axis_1.Logarithmic, column_series_1.ColumnSeries, area_series_1.AreaSeries, bar_series_1.BarSeries, date_time_axis_1.DateTime, category_axis_1.Category, legend_1.Legend, multi_level_labels_1.MultiLevelLabel);
    ...
    describe('Chart Control', function () {
        ...
        describe('Chart Multiple labels - category axis', function () {
            var chartObj;
            var elem;
            var svg;
            var text;
            ...
            beforeAll(function () {
                ...
                chartObj = new chart_1.Chart({
                    ...
                    series: [{
                            dataSource: data_spec_1.categoryData, xName: 'x', yName: 'y', animation: { enable: false }, type: 'Line',
            ...
            it('Checking multilevel labels', function (done) {
            ...
            it('Checking multilevel labels with onTicks', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container0_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
            ...
            it('Checking multilevel labels with inversed', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container0_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
            ...
            it('Checking multilevel labels with transposed', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container0_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
            ...
            it('Checking multilevel labels with levels', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container0_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
                    expect(svg.getAttribute('x') === '186.96875' || svg.getAttribute('x') === '232.90625' ||
                    ...
                    var level_2_Elements = document.getElementById('container0_Axis_MultiLevelLabel_Level_1_Text_0');
            ...
            it('Checking multilevel labels with title and legend', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container0_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
                    expect(svg.getAttribute('x') === '186.96875' || svg.getAttribute('x') === '232.90625' ||
            ...
            it('Checking multilevel labels with border color', function (done) {
                loaded = function (args) {
            ...
            it('Checking multilevel labels with label rotation', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container0_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
                    expect(svg.getAttribute('x') === '186.96875' || svg.getAttribute('x') === '232.90625' ||
            ...
            it('Checking multilevel labels with label rotation and label positioon inside', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container0_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
            ...
            it('Checking multilevel labels opposedPosition', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container0_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
                    expect(svg.getAttribute('x') === '186.96875' || svg.getAttribute('x') === '185.78125' ||
            ...
            it('Checking multilevel labels opposedPosition and label outside position', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container0_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
                    expect(svg.getAttribute('x') === '186.96875' || svg.getAttribute('x') === '232.90625' ||
            ...
            it('Checking multilevel labels with text alignment far and maximumTextWidth', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container0_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
            ...
            it('Checking multilevel labels with text alignment near', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container0_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
            ...
            it('Checking multilevel labels with border type brace', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container0_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
                    expect(svg.getAttribute('x') === '186.96875' || svg.getAttribute('x') === '232.90625' ||
            ...
            it('Checking multilevel labels with border type brace with alignment far', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container0_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
                    expect(svg.getAttribute('x') === '310.9375' || svg.getAttribute('x') === '402.8125' ||
            ...
            it('Checking multilevel labels with border type brace with alignment near', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container0_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
                    expect(svg.getAttribute('x') === '63' || svg.getAttribute('x') === '62' ||
            ...
            it('Checking multilevel labels with border type brace with opposedposition false', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container0_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
                    expect(svg.getAttribute('x') === '186.96875' || svg.getAttribute('x') === '232.90625' ||
            ...
            it('Checking multilevel labels with border type withoutborder', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container0_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
                    svg = document.getElementById('container0_Axis_MultiLevelLabel_Rect_0_0');
            ...
            it('Checking multilevel labels with border type withoutTopandBottomBorder', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container0_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
                    expect(svg.getAttribute('x') === '186.96875' || svg.getAttribute('x') === '232.90625' ||
            ...
            it('Checking multilevel labels with border type withoutTopBorder', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container0_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
                    expect(svg.getAttribute('x') === '186.96875' || svg.getAttribute('x') === '232.90625' ||
            ...
            it('Checking multilevel labels with border type withoutTopBorder with opposedposition false', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container0_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
                    expect(svg.getAttribute('x') === '186.96875' || svg.getAttribute('x') === '232.90625' ||
            ...
            it('Checking primary axis labels with border type withoutBorder', function (done) {
                loaded = function (args) {
            ...
            it('Checking primary axis labels with border type withouttopandbottomborder', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container_BorderLine_0');
                    expect(svg !== null).toBe(true);
                    done();
            ...
            it('Checking primary axis labels with border type withouttopborder and label position inside', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container_BorderLine_0');
                    expect(svg !== null).toBe(true);
                    done();
            ...
            it('Checking primary axis labels with border type rectangle and label position inside and opposedposition', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container_BorderLine_0');
                    expect(svg !== null).toBe(true);
                    done();
            ...
            it('Checking primary axis labels with border type rectangle and label position outside and opposedposition', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container_BorderLine_0');
                    expect(svg !== null).toBe(true);
                    done();
            ...
            it('Checking border type curlybrace with alignment center', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container0_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
                    expect(svg.getAttribute('x') === '186.96875' || svg.getAttribute('x') === '232.90625' ||
            ...
            it('Checking border type curlybrace with alignment far', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container0_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
                    expect(svg.getAttribute('x') === '310.9375' || svg.getAttribute('x') === '402.8125' ||
            ...
            it('Checking border type curlybrace with alignment near', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container0_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
                    expect(svg.getAttribute('x') === '63' || svg.getAttribute('x') === '62' ||
            ...
            it('Checking border type curlybrace with opposedPosition false', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container0_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
                    expect(svg.getAttribute('x') === '63' || svg.getAttribute('x') === '62' ||
        ...
        describe('Chart Multiple labels click - Category axis', function () {
            var chartObj;
            var elem;
            var svg;
            var text;
            ...
            it('Checking the multi level labels after click event in x axis', function (done) {
                var elem1;
                loaded = function (args) {
                ...
                multilevellabelclick = function (args) {
                    var object = args.customAttributes;
                    expect(Object.values(object)[0]).toBe('sesson1');
                    expect(Object.values(object)[1]).toBe('through1');
                };
                chartObj.loaded = loaded;
                chartObj.multiLevelLabelClick = multilevellabelclick;
                chartObj.refresh();
            });
            it('Checking the multi level labels after click event in y axis', function (done) {
                var elem1;
                loaded = function (args) {
                ...
                multilevellabelclick = function (args) {
                    var object = args.customAttributes;
                    expect(Object.values(object)[0]).toBe('Half Yearly 3');
                    expect(Object.values(object)[1]).toBe('through3');
                };
                chartObj.loaded = loaded;
                chartObj.multiLevelLabelClick = multilevellabelclick;
                chartObj.refresh();
            });
            it('Checking the multi level labels after click event, date access in custom objects', function (done) {
                var elem1;
                loaded = function (args) {
                ...
                multilevellabelclick = function (args) {
                    var object = args.customAttributes;
                    var startDate = new Date(Object.values(object)[0]);
                    var endDate = new Date(Object.values(object)[1]);
        ...
        describe('Chart Multi Level labels click event - DateTime axis and Logarithmic axis', function () {
            var chartObj;
            var elem;
            var svg;
            var text;
            ...
            it('Checking the multi level labels after click event in x axis', function (done) {
                ...
                multilevellabelclick = function (args) {
                    var object = args.customAttributes;
                    expect(Object.values(object)[0]).toBe('In Season1');
                    expect(Object.values(object)[1]).toBe('through');
                };
                chartObj.loaded = loaded;
                chartObj.multiLevelLabelClick = multilevellabelclick;
                chartObj.refresh();
        ...
        describe('Chart Multi Level labels click event - Double', function () {
            var chartObj;
            var elem;
            var svg;
            var text;
        ...
        describe('Chart Multiple labels - DateTime axis', function () {
            var chartObj;
            var elem;
            var svg;
            var text;
        ...
        describe('Chart Multiple labels - Double', function () {
            var chartObj;
            var elem;
            var svg;
            var text;
            ...
            beforeAll(function () {
                ...
                chartObj = new chart_1.Chart({
                    ...
                    primaryYAxis: { title: 'PrimaryYAxis', rangePadding: 'None' },
                    series: [{
                            dataSource: data_spec_1.seriesData1, xName: 'x', yName: 'y', animation: { enable: false }, type: 'Line',
                            name: 'ChartSeriesNameGold', fill: 'green',
                        }], legendSettings: { visible: false }
                });
            });
            ...
            it('Checking multilevel labels with levels and diff axis border type rectangle', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container_BorderLine_0');
                    expect(svg !== null).toBe(true);
                    done();
            ...
            it('Checking multilevel labels with levels and diff axis border type withouttopandbottomborder', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container_BorderLine_0');
                    expect(svg !== null).toBe(true);
                    done();
            ...
            it('Checking multilevel labels with levels and diff axis border type withouttopborder', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container_BorderLine_0');
                    expect(svg !== null).toBe(true);
                    done();
            ...
            it('Checking multilevel labels with levels and diff axis border type withouttopborder labelPosition inside', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container_BorderLine_0');
                    expect(svg !== null).toBe(true);
                    done();
        ...
        describe('Chart Multiple labels - multiple axis', function () {
            var chartObj;
            var elem;
            var svg;
            var text;
        ...
        describe('Chart Multiple labels Vertical- Double', function () {
            var chartObj;
            var elem;
            var svg;
            var text;
            ...
            it('Checking multilevel labels', function (done) {
                loaded = function (args) {
                    ...
                    var level_2_Elements = document.getElementById('container1_Axis_MultiLevelLabel_Level_1_Text_0');
            ...
            it('diff axis border type rectangle', function (done) {
                loaded = function (args) {
            ...
            it('diff axis border type withouttopandbottomborder', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container_BorderLine_1');
                    expect(svg !== null).toBe(true);
                    done();
            ...
            it('diff axis border type withouttopborder', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container_BorderLine_1');
                    expect(svg !== null).toBe(true);
                    done();
            ...
            it('diff axis border type withouttopborder labelPosition inside', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container_BorderLine_1');
                    expect(svg !== null).toBe(true);
                    done();
            ...
            it('multi level labels with border type withouttopandbottomborder', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container1_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
            ...
            it('multi level labels with border type withouttopborder', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container1_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
                    expect(svg.getAttribute('x') === '61.5' || svg.getAttribute('x') === '59').toBe(true);
            ...
            it('multi level labels with border type withouttopborder with label Position inside', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container1_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
                    expect(svg.getAttribute('x') === '61.5' || svg.getAttribute('x') === '59').toBe(true);
            ...
            it('multi level labels with border type withouttopborder with label Position inside and opposed position ', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container1_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
            ...
            it('multi level labels with border type withouttopborder with label Position outside and opposed position ', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container1_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
            ...
            it('multi level labels with border type brace', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container1_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
                    expect(svg.getAttribute('x') === '82.5' || svg.getAttribute('x') === '82.5' ||
            ...
            it('multi level labels with border type brace with label Position inside', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container1_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
            ...
            it('multi level labels with border type brace and label positon outside and opposedposition', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container1_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
                    expect(svg.getAttribute('x') === '675.5' || svg.getAttribute('x') === '920.5' ||
            ...
            it('multi level labels with border type brace with label Position inside and opposed position ', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container1_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
                    expect(svg.getAttribute('x') === '696.5' || svg.getAttribute('x') === '942' ||
            ...
            it('multi level labels with border type curlybrace', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container1_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
            ...
            it('multi level labels with border type curlybrace with far alignment', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container1_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
                    expect(svg.getAttribute('x') === '76.5' || svg.getAttribute('x') === '76' ||
            ...
            it('multi level labels with border type curlybrace with near alignment', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container1_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
                    expect(svg.getAttribute('x') === '76.5' || svg.getAttribute('x') === '76' ||
            ...
            it('multi level labels with border type curlybrace with label Position inside', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container1_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
                    expect(svg.getAttribute('x') === '76.5' || svg.getAttribute('x') === '76' ||
            ...
            it('multi level labels with border type curlybrace and opposed positon and label position outside', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container1_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
            ...
            it('multi level labels with border type curlybrace with label Position inside and opposed position ', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container1_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
            ...
            it('Checking with maximumTextWidth', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container1_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
                    expect(svg.getAttribute('x') === '681.5' || svg.getAttribute('x') === '927' ||
            ...
            it('Checking with without border type', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container1_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
                    expect(svg.getAttribute('x') === '696.5' || svg.getAttribute('x') === '942' ||
            ...
            it('Checking with start range less than axis visible range', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container1_Axis_MultiLevelLabel_Level_0_Text_0');
                    expect(svg !== null).toBe(true);
                    expect(svg.getAttribute('x') === '681.5' || svg.getAttribute('x') === '927' ||
            ...
            it('Checking with zoom factor for withouttopborder border type', function (done) {
                loaded = function (args) {
            ...
            it('Checking with zoom factor for rectangle border type', function (done) {
                loaded = function (args) {
                    svg = document.getElementById('container1_Axis_MultiLevelLabel_Rect_0_0');
                    expect(svg !== null).toBe(true);
                    done();
        ...
        describe('Chart Multiple labels - Line break labels', function () {
            var chart;
            var elem;
            var svg;
            var text;
            ...
            it('default line break checking with multi level labels', function (done) {
                loaded = function (args) {
            ...
            it('multi level labels-line break labels with inversed axis', function (done) {
                loaded = function (args) {
                    var label = document.getElementById('containerAxisLabels0');
                    expect(label.childElementCount == 6).toBe(true);
                    label = document.getElementById('container0_AxisLabel_0');
            ...
            it('Multi level labels-line break labels with opposed position true', function (done) {
                loaded = function (args) {
                    var label = document.getElementById('containerAxisLabels0');
                    expect(label.childElementCount == 6).toBe(true);
                    label = document.getElementById('container0_AxisLabel_0');
            ...
            it('Multi level labels-line break labels with 90 deg rotation', function (done) {
                loaded = function (args) {
                    var label = document.getElementById('containerAxisLabels0');
                    expect(label.childElementCount == 6).toBe(true);
                    label = document.getElementById('container0_AxisLabel_0');
            ...
            it('Checking border type with category type', function (done) {
                loaded = function (args) {
                    var firstPath = document.getElementById('container0_Axis_MultiLevelLabel_Rect_0_0').getAttribute('d');
                    expect(firstPath.indexOf('C') !== -1).toBe(true);
                    var secondPath = document.getElementById('container0_Axis_MultiLevelLabel_Rect_0_1').getAttribute('d');
                    expect(secondPath.indexOf('C') === -1).toBe(true);
                    var thirdPath = document.getElementById('container0_Axis_MultiLevelLabel_Rect_0_2');
        ...
        describe('Chart Multiple labels - Bar series type', function () {
            var chart;
            var elem;
            var svg;
            var text;
            ...
            it('Checking primary axis labels with border alignment', function (done) {
                loaded = function (args) {
                    var path;
                    var checkPath = [];
                    svg = document.getElementById('container_BorderLine_0');
