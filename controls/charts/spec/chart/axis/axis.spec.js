define(["require", "exports", "@syncfusion/ej2-base", "../../../src/chart/chart", "../../../src/chart/series/line-series", "../../../src/chart/series/column-series", "../../../src/chart/series/area-series", "../../../src/chart/axis/category-axis", "../base/events.spec", "../base/data.spec", "../../../src/index", "../../../src/index", "../../common.spec", "../base/data.spec", "../../../node_modules/es6-promise/dist/es6-promise"], function (require, exports, ej2_base_1, chart_1, line_series_1, column_series_1, area_series_1, category_axis_1, events_spec_1, data_spec_1, index_1, index_2, common_spec_1, data_spec_2) {
    "use strict";
    var _this = this;
    Object.defineProperty(exports, "__esModule", { value: true });
    chart_1.Chart.Inject(line_series_1.LineSeries, category_axis_1.Category, column_series_1.ColumnSeries, index_1.DateTime, index_2.Logarithmic, index_1.Zoom, index_1.ScrollBar, area_series_1.AreaSeries);
    describe('Chart Control', function () {
        ...
        describe('Axis Behavior', function () {
            ...
            it('Checking the row definition', function (done) {
                loaded = function (args) {
                    var axis = document.getElementById('chartContainerAxisInsideCollection');
            ...
            it('Checking Both Axis Major Ticklines Inside Position', function () {
                chartObj.primaryXAxis.majorGridLines = { color: '#C2C924', width: 2 };
                chartObj.primaryXAxis.majorTickLines = { color: '#0AA368', width: 1.5, height: 20 };
                ...
                var value1 = parseInt(Position[5]);
                var value2 = parseInt(Position[11]);
                expect(svg.getAttribute('value1') === svg.getAttribute('value2')).toBe(true);
                svg = document.getElementById('chartContainer_MajorTickLine_1_0');
                Position = svg.getAttribute('d').split(' ');
                var value11 = parseInt(Position[8]);
                var value12 = parseInt(Position[11]);
                expect(svg.getAttribute('value11') === svg.getAttribute('value21')).toBe(true);
            });
            it('Checking label x axis label position inside', function () {
            ...
            it('Checking Y axis label position inside ', function () {
                chartObj.primaryXAxis = { title: 'PrimaryXAxis', rangePadding: 'Additional' };
                chartObj.primaryYAxis = { title: 'PrimaryYAxis', rangePadding: 'Normal' };
            ...
            it('Checking the zoomFactor and zoomPosition with inversed', function () {
                loaded = function (args) {
                    text = document.getElementById('chartContainer0_AxisLabel_0');
        ...
        describe('Axis Behavior', function () {
            ...
            it('checking minor gridlines', function (done) {
                chart.loaded = function (args) {
                    var tick = document.getElementById('chartContainer_MinorGridLine_0_0');
                    var border = document.getElementById('chartContainer_ChartAreaBorder');
            ...
            it('checking y axis as inversed axis', function (done) {
                loaded = function (args) {
                    var firstLabel = document.getElementById('chartContainer1_AxisLabel_0');
                    expect(firstLabel.textContent).toEqual('0');
                    var lastLabel = document.getElementById('chartContainer1_AxisLabel_10');
            ...
            it('checking x axis as inversed axis', function (done) {
                loaded = function (args) {
                    ...
                    expect(firstLabel.textContent).toEqual('0');
                    var secondLabel = document.getElementById('chartContainer0_AxisLabel_5');
            ...
            it('checking inversed axis with label intersect action', function (done) {
                loaded = function (args) {
                    var firstLabel = document.getElementById('chartContainer0_AxisLabel_0');
                    expect(firstLabel.textContent).toEqual('1customLabels');
                    var secondLabel = document.getElementById('chartContainer0_AxisLabel_1');
                    expect(secondLabel).toEqual(null);
                    var thirdLabel = document.getElementById('chartContainer0_AxisLabel_2');
            ...
            it('checcking inversed axis with labelintersect action as none', function (done) {
                loaded = function (args) {
                    var firstLabel = document.getElementById('chartContainer0_AxisLabel_0');
                    expect(firstLabel.textContent).toEqual('1customLabels');
                    var secondLabel = document.getElementById('chartContainer0_AxisLabel_1');
            ...
            it('checcking labelintersect action as rotate45 inside position', function (done) {
                loaded = function (args) {
                    var firstLabel = document.getElementById('chartContainer0_AxisLabel_0');
                    expect(firstLabel.textContent).toEqual('1customLabels');
            ...
            it('checcking inversed axis with labelintersect action as rotate90', function (done) {
                loaded = function (args) {
                    var firstLabel = document.getElementById('chartContainer0_AxisLabel_0');
                    expect(firstLabel.textContent).toEqual('1customLabels');
            ...
            it('checcking labelintersect action as rotate90 inside position', function (done) {
                loaded = function (args) {
                    var firstLabel = document.getElementById('chartContainer0_AxisLabel_0');
                    expect(firstLabel.textContent).toEqual('1customLabels');
                    expect(firstLabel.getAttribute('transform').indexOf('rotate(90') > -1).toBe(true);
            ...
            it('checcking opposed position with labelintersect action as rotate90 inside position', function (done) {
                loaded = function (args) {
                    var firstLabel = document.getElementById('chartContainer0_AxisLabel_0');
                    expect(firstLabel.textContent).toEqual('1customLabels');
                    expect(firstLabel.getAttribute('transform').indexOf('rotate(90') > -1).toBe(true);
            ...
            it('checking with multiple axes', function (done) {
                loaded = function (args) {
                    var firstLabel = document.getElementById('chartContainer2_AxisLabel_0');
                    expect(firstLabel.textContent).toEqual('24');
                    var secondLabel = document.getElementById('chartContainer2_AxisLabel_1');
            ...
            it('checking with multiple panes', function (done) {
                loaded = function (args) {
                    var firstLabel = document.getElementById('chartContainer2_AxisLabel_0');
                    expect(firstLabel.textContent).toEqual('24');
                    var secondLabel = document.getElementById('chartContainer2_AxisLabel_1');
        ...
        describe('Axis Smartlabels', function () {
            var chart;
            ...
            it('Checking with MultipleRows', function (done) {
                loaded = function (args) {
                    text = document.getElementById('chartContainer0_AxisLabel_0');
                    var text1 = document.getElementById('chartContainer0_AxisLabel_1');
                    expect(text1.getAttribute('y') > text.getAttribute('y')).toBe(true);
                    var text4 = document.getElementById('chartContainer0_AxisLabel_4');
                    expect(text.getAttribute('y') === text4.getAttribute('y')).toBe(true);
                    var height = document.getElementById('chartContainer_ChartAreaBorder');
                    expect(parseFloat(height.getAttribute('height')) < 250).toBe(true);
                    done();
                };
                chart.loaded = loaded;
            ...
            it('Checking with MultipleRows label inside position', function (done) {
                loaded = function (args) {
                    text = document.getElementById('chartContainer0_AxisLabel_0');
                    var text1 = document.getElementById('chartContainer0_AxisLabel_1');
                    expect(text1.getAttribute('y') < text.getAttribute('y')).toBe(true);
            ...
            it('Checking with MultipleRows with Oppossed', function (done) {
                loaded = function (args) {
                    text = document.getElementById('chartContainer0_AxisLabel_0');
                    var text1 = document.getElementById('chartContainer0_AxisLabel_1');
                    expect(text1.getAttribute('y') < text.getAttribute('y')).toBe(true);
                    var element = document.getElementById('chartContainer_ChartAreaBorder');
                    expect(parseFloat(element.getAttribute('y')) > 50).toBe(true);
                    done();
                };
                chart.loaded = loaded;
                chart.primaryXAxis.opposedPosition = true;
            ...
            it('Checking with Wraps', function (done) {
                loaded = function (args) {
                    text = document.getElementById('chartContainer0_AxisLabel_0');
                    expect(text.childNodes.length == 3).toBe(true);
            ...
            it('Checking with Wraps with labels inside', function (done) {
                loaded = function (args) {
                    text = document.getElementById('chartContainer0_AxisLabel_4');
                    expect(text.childNodes.length == 4).toBe(true);
                    text = document.getElementById('chartContainer0_AxisLabel_0');
                    expect(text.childNodes.length == 3).toBe(true);
                    expect(text.childNodes[1].textContent.indexOf('...') > -1).toBe(true);
                    var axis = document.getElementById('chartContainerAxisLine_0');
            ...
            it('Checking with Wraps with Oppossed', function (done) {
                loaded = function (args) {
                    text = document.getElementById('chartContainer0_AxisLabel_0');
                    expect(text.childNodes.length == 3).toBe(true);
            ...
            it('Checking with MultipleRows with inversed', function (done) {
                loaded = function (args) {
                    text = document.getElementById('chartContainer0_AxisLabel_0');
                    var text1 = document.getElementById('chartContainer0_AxisLabel_1');
                    expect(text1.getAttribute('y') < text.getAttribute('y')).toBe(true);
            ...
            it('Checking with Trim to be true', function (done) {
                loaded = function (args) {
                    text = document.getElementById('chartContainer0_AxisLabel_0');
                    expect(text.textContent.indexOf('...') > -1).toBe(true);
                    expect(text.textContent.split('...').length).toEqual(2);
            ...
            it('Checking enable trim when label position inside', function () {
            ...
            it('Checking enable trim when label position outside', function () {
                chart.primaryXAxis = { title: 'PrimaryXAxis', rangePadding: 'Additional' };
                chart.primaryXAxis.labelPosition = 'Outside',
                    chart.primaryXAxis.enableTrim = true,
            ...
            it('Checking with enable Trim for label intersection Action Wrap', function (done) {
                loaded = function (args) {
                    text = document.getElementById('chartContainer0_AxisLabel_0');
                    expect(text.textContent.indexOf('...') > -1).toBe(true);
                    expect(text.textContent.split('...').length).toEqual(2);
            ...
            it('Checking with enable Trim for label intersection Action Multiple rows', function (done) {
                loaded = function (args) {
                    text = document.getElementById('chartContainer0_AxisLabel_0');
                    expect(text.textContent.indexOf('...') > -1).toBe(true);
                    expect(text.textContent.split('...').length).toEqual(2);
            ...
            it('Checking with maximum label width property', function (done) {
                loaded = function (args) {
                    var label1 = document.getElementById('chartContainer0_AxisLabel_0');
            ...
            it('Checking with label width', function (done) {
                loaded = function (args) {
                    var maximumLabelWidth = document.getElementById('chartContainer0_AxisLabel_0');
        ...
        describe('Axis Visible false and true size calculation checking', function () {
            var chart;
            var label;
            var temp;
            beforeAll(function () {
            ...
            it('Checking visible true', function (done) {
                loaded = function (args) {
            ...
            it('Checking visible false y axis and x axis', function (done) {
        ...
        describe('Checking the Axis Crossing for Numeric Axis', function () {
            var chartEle;
            ele = ej2_base_1.createElement('div', { id: 'chartContainer' });
            beforeAll(function () {
                document.body.appendChild(ele);
                ...
                data_spec_1.unbindResizeEvents(chartEle);
            });
            afterAll(function () {
                chartEle.destroy();
                ele.remove();
            });
            it('With X-Axis Opposed Position and Crossing Value Less than Visible Range', function (done) {
                loaded = function (args) {
                    var insideGroup = document.getElementById('chartContainerAxisInsideCollection');
                    var outsideGroup = document.getElementById('chartContainerAxisOutsideCollection');
                    var chartArea = document.getElementById('chartContainer_ChartAreaBorder');
                    var xAxisInside = outsideGroup.children[0];
                    var xLine = xAxisInside.children[0];
                ...
                chartEle.axisLabelRender = function (args) {
                };
            ...
            it('With Y-Axis Opposed Position and Crossing Value Less than Visible Range', function (done) {
                loaded = function (args) {
                    var insideGroup = document.getElementById('chartContainerAxisInsideCollection');
                    var outsideGroup = document.getElementById('chartContainerAxisOutsideCollection');
                    var chartArea = document.getElementById('chartContainer_ChartAreaBorder');
                    var yAxisInside = outsideGroup.children[1];
                    var yLine = yAxisInside.children[0];
                    expect(insideGroup.childElementCount).toBe(3);
            ...
            it('With X and Y Axis Inversed', function (done) {
                loaded = function (args) {
                    var outsideGroup = document.getElementById('chartContainerAxisOutsideCollection');
                    var xAxisInside = outsideGroup.children[0];
                    var yAxisInside = outsideGroup.children[1];
            ...
            it('With X-Axis Visibility to false', function (done) {
                loaded = function (args) {
                    var xLine = document.getElementById('chartContainerAxisLine_0');
            ...
            it('With Y-Axis Visibility to false', function (done) {
                loaded = function (args) {
        ...
        describe('Checking Axis Crossing with Category Axis', function () {
            var chartEle;
            ele = ej2_base_1.createElement('div', { id: 'chartContainer' });
            beforeAll(function () {
                document.body.appendChild(ele);
            ...
            it('By Specifying Cross value in Numeric', function (done) {
                loaded = function (args) {
                    var yLine = document.getElementById('chartContainerAxisLine_1');
            ...
            it('By Specifying Cross value in String Value not in the Data Source', function (done) {
                loaded = function (args) {
                    var yLine = document.getElementById('chartContainerAxisLine_1');
        ...
        describe('Checking Axis Crossing with DateTime Axis', function () {
            var chartEle;
            ele = ej2_base_1.createElement('div', { id: 'chartContainer' });
            beforeAll(function () {
                document.body.appendChild(ele);
            ...
            it('With DateTime', function (done) {
                loaded = function (args) {
                    var yLine = document.getElementById('chartContainerAxisLine_1');
                    expect(yLine.getAttribute('d').split(' ')[1] === '400' && yLine.getAttribute('d').split(' ')[4] === '400').toBe(true);
                    done();
        ...
        describe('Checking Axis Crossing with Logarthmic Axis', function () {
            var chartEle;
            ele = ej2_base_1.createElement('div', { id: 'chartContainer' });
            beforeAll(function () {
                document.body.appendChild(ele);
            ...
            it('With Log values', function (done) {
                loaded = function (args) {
                    var yLine = document.getElementById('chartContainerAxisLine_1');
            ...
            it('With Minor Tick Lines for X-Axis', function (done) {
                loaded = function (args) {
                    var xLine = document.getElementById('chartContainerAxisLine_0');
            ...
            it('With Minor Tick Lines for Y-Axis', function (done) {
                loaded = function (args) {
                    var yLine = document.getElementById('chartContainerAxisLine_1');
                    expect(yLine.getAttribute('d').split(' ')[1] === '394.0515262271122' && yLine.getAttribute('d').split(' ')[4] === '394.0515262271122').toBe(true);
                    done();
            ...
            it('Minor Tick with Opposed Position for X-Axis', function (done) {
                loaded = function (args) {
                    var xLine = document.getElementById('chartContainerAxisLine_0');
                    var majorTickX = document.getElementById('chartContainer_MajorTickLine_0_0');
                    var minorTickX = document.getElementById('chartContainer_MinorTickLine_0_1');
            ...
            it('Minor Tick with Opposed Position for Y-Axis', function (done) {
                loaded = function (args) {
                    var yLine = document.getElementById('chartContainerAxisLine_1');
                    var majorTickY = document.getElementById('chartContainer_MajorTickLine_1_0');
                    var minorTickY = document.getElementById('chartContainer_MinorTickLine_1_0');
                    expect(yLine.getAttribute('d').split(' ')[1] === '394.0515262271122' && yLine.getAttribute('d').split(' ')[4] === '394.0515262271122').toBe(true);
        ...
        describe('Checking Axis Crossing with Multiple Y Axis', function () {
            var chartEle;
            ele = ej2_base_1.createElement('div', { id: 'chartContainer' });
            beforeAll(function () {
                document.body.appendChild(ele);
            ...
            it('All Axis Moved', function (done) {
                loaded = function (args) {
                    var xLine1 = document.getElementById('chartContainerAxisLine_0');
                    var yLine1 = document.getElementById('chartContainerAxisLine_1');
                    var yLine2 = document.getElementById('chartContainerAxisLine_2');
                    var chartArea = document.getElementById('chartContainer_ChartAreaBorder');
        ...
        describe('Checking Axis Crossing with Multiple X Axis', function () {
            var chartEle;
            ele = ej2_base_1.createElement('div', { id: 'chartContainer' });
            beforeAll(function () {
                document.body.appendChild(ele);
            ...
            it('All Axis Moved', function (done) {
                loaded = function (args) {
                    var line0 = document.getElementById('chartContainerAxisLine_0');
                    var line1 = document.getElementById('chartContainerAxisLine_1');
                    var line2 = document.getElementById('chartContainerAxisLine_2');
                    var chartArea = document.getElementById('chartContainer_ChartAreaBorder');
        ...
        describe('Checking Axis range auto on zooming', function () {
            var chartEle;
            ele = ej2_base_1.createElement('div', { id: 'chartContainer' });
            beforeAll(function () {
                document.body.appendChild(ele);
            ...
            it('Checking axis in Zoom mode X', function () {
            ...
            it('Checking axis in Zoom mode Y', function () {
        ...
        describe('Checking Axis Label Click Event', function () {
            var chartContainer;
            var chartObj;
            var titleElement;
            var trigger = new events_spec_1.MouseEvents();
            chartContainer = ej2_base_1.createElement('div', { id: 'container' });
            beforeAll(function () {
            ...
            it('default axis label click event checking', function (done) {
                chartObj.loaded = function () {
                    var lableElement = document.getElementById('container0_AxisLabel_3');
        ...
        describe('Checking minor grid lines with inversed vertical axis', function () {
            var chartContainer;
            var chartObj;
            chartContainer = ej2_base_1.createElement('div', { id: 'container' });
            ...
            it('checking first and last minor grid lines', function (done) {
                chartObj.loaded = function () {
                    var gridLineElement = document.getElementById('container_MinorGridLine_1_0');
                    var path = gridLineElement.getAttribute("d");
        ...
        describe('Checking axis minor grid line while zooming', function () {
            var chartContainer;
            var numericSeriesData = [];
            var logSeriesData = [];
            var logSeriesData2 = [];
            var dateTimeData = [];
            var point;
            var minorGridElement;
            var i;
            for (i = 0; i < 101; i++) {
            ...
            it('X axis with double', function (done) {
                chartObj.loaded = function () {
            ...
            it('X axis with date time', function (done) {
                chartObj.loaded = function () {
                    minorGridElement = document.getElementById('container_MinorGridLine_0_-1');
                    expect(minorGridElement !== null).toBe(true);
                    minorGridElement = document.getElementById('container_MinorTickLine_0_-1');
            ...
            it('X axis with logarithmic', function (done) {
                chartObj.loaded = function () {
                    minorGridElement = document.getElementById('container_MinorGridLine_0_-1');
                    expect(minorGridElement !== null).toBe(true);
                    minorGridElement = document.getElementById('container_MinorTickLine_0_-1');
            ...
            it('Y axis with logarithmic', function (done) {
                chartObj.loaded = function () {
            ...
            it('Y axis with double', function (done) {
                chartObj.loaded = function () {
                    minorGridElement = document.getElementById('container_MinorGridLine_1_-1');
                    expect(minorGridElement !== null).toBe(true);
                    done();
        ...
        describe('Check the RTL behaviour for axis', function () {
            var chart;
            var ele;
            var loaded;
            var element;
            ...
            it('Checking the vertical axis', function (done) {
                loaded = function (args) {
