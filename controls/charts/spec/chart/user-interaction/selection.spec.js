define(["require", "exports", "@syncfusion/ej2-base", "../../../src/chart/chart", "../../../src/chart/user-interaction/selection", "../../../src/chart/user-interaction/zooming", "../../../src/chart/series/line-series", "../../../src/chart/series/step-line-series", "../../../src/chart/series/column-series", "../../../src/chart/series/stacking-column-series", "../../../src/chart/series/stacking-area-series", "../../../src/chart/series/area-series", "../../../src/chart/legend/legend", "../base/events.spec", "../../../src/chart/user-interaction/data-editing", "../base/data.spec", "../../common.spec", "../../../node_modules/es6-promise/dist/es6-promise"], function (require, exports, ej2_base_1, chart_1, selection_1, zooming_1, line_series_1, step_line_series_1, column_series_1, stacking_column_series_1, stacking_area_series_1, area_series_1, legend_1, events_spec_1, data_editing_1, data_spec_1, common_spec_1) {
    "use strict";
    var _this = this;
    Object.defineProperty(exports, "__esModule", { value: true });
    chart_1.Chart.Inject(line_series_1.LineSeries, data_editing_1.DataEditing, step_line_series_1.StepLineSeries, column_series_1.ColumnSeries, area_series_1.AreaSeries, stacking_area_series_1.StackingAreaSeries, selection_1.Selection, stacking_column_series_1.StackingColumnSeries, legend_1.Legend, zooming_1.Zoom);
    ...
    describe('Chart Control Selection ', function () {
        ...
        it('MultiSelect false Selection Mode Cluster', function (done) {
            loaded = function () {
                ...
                for (var i_1 = 0; i_1 < seriesCollection.length; i_1++) {
                    expect(document.getElementsByClassName(selection + i_1).length).toBe(3);
                }
                done();
            };
        ...
        it('MultiSelect true Selection Mode  Cluster', function (done) {
            loaded = function () {
                ...
                for (var i_2 = 0; i_2 < seriesCollection.length; i_2++) {
                    expect(document.getElementsByClassName(selection + i_2).length).toBe(3);
                }
                done();
            };
            chartObj.selectionMode = 'Cluster';
        ...
        it('UnSelectionStyle selection', function (done) {
            loaded = function () {
        ...
        it('Selection mode multi select dragging', function (done) {
            loaded = function () {
                trigger.draganddropEvent(chartContainer, 100, 100, 300, 300);
    ...
    describe('Range color mapping charts selection in Point mode', function () {
        ...
        var loaded;
        var trigger = new events_spec_1.MouseEvents();
        var id = 'rangeColorMapping';
        var element2 = ej2_base_1.createElement('div', { id: 'rangeColorMapping' });
        beforeAll(function () {
    ...
    describe('Point color mapping chart highlight and selection', function () {
        ...
        var loaded;
        var trigger = new events_spec_1.MouseEvents();
        var id = 'PointColorMapping';
        var element1 = ej2_base_1.createElement('div', { id: 'PointColorMapping' });
        beforeAll(function () {
    ...
    describe('Line series point drag and drop with range selection', function () {
        var chartObj;
        var x;
        var y;
        var loaded;
        ...
        it('line series drag and drop with range selection', function (done) {
            loaded = function () {
