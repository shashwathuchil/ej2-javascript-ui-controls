define(["require", "exports", "@syncfusion/ej2-base", "../../../src/chart/chart", "../../../src/chart/series/data-label", "../../../src/chart/series/polar-series", "../../../src/chart/series/radar-series", "../../../src/chart/series/line-series", "../../../src/chart/series/area-series", "../../../src/chart/axis/date-time-axis", "../../../src/chart/axis/logarithmic-axis", "../../../src/chart/axis/category-axis", "../../../src/common/utils/helper", "../../../src/chart/legend/legend", "../../../src/chart/user-interaction/tooltip", "../base/data.spec", "../../common.spec", "../base/data.spec", "../../../node_modules/es6-promise/dist/es6-promise"], function (require, exports, ej2_base_1, chart_1, data_label_1, polar_series_1, radar_series_1, line_series_1, area_series_1, date_time_axis_1, logarithmic_axis_1, category_axis_1, helper_1, legend_1, tooltip_1, data_spec_1, common_spec_1, data_spec_2) {
    "use strict";
    var _this = this;
    Object.defineProperty(exports, "__esModule", { value: true });
    chart_1.Chart.Inject(date_time_axis_1.DateTime, category_axis_1.Category, tooltip_1.Tooltip, logarithmic_axis_1.Logarithmic, polar_series_1.PolarSeries, area_series_1.AreaSeries, line_series_1.LineSeries, radar_series_1.RadarSeries, data_label_1.DataLabel, legend_1.Legend);
    ...
    describe('Chart Control', function () {
        ...
        describe('Polar Axis', function () {
            ...
            beforeAll(function () {
                ...
                chartObj = new chart_1.Chart({
                    series: [{
                            dataSource: data_spec_2.tool1, xName: 'x', yName: 'y', type: 'Polar', drawType: 'Line', animation: { enable: true }
                        }],
                });
            });
            afterAll(function () {
            ...
            it('Checking the centerX, centerY and radius and labels', function (done) {
                loaded = function (args) {
                    var centerX = args.chart.chartAxisLayoutPanel.seriesClipRect.width / 2 + args.chart.chartAxisLayoutPanel.seriesClipRect.x;
                    var centerY = args.chart.chartAxisLayoutPanel.seriesClipRect.width / 2 + args.chart.chartAxisLayoutPanel.seriesClipRect.y;
            ...
            it('Checking axis visible false', function (done) {
                loaded = function (args) {
                    var label = document.getElementById('chartContainer0_AxisLabel_0');
            ...
            it('Checking y axis linestyle visible false', function (done) {
                loaded = function (args) {
                    var label = document.getElementById('chartContainerAxisLine_1');
                    expect(label === null).toBe(true);
                    done();
                };
                chartObj.loaded = loaded;
            ...
            it('Checking labels with startAngle for axis', function (done) {
                loaded = function (args) {
                    var centerX = args.chart.chartAxisLayoutPanel.seriesClipRect.width / 2 + args.chart.chartAxisLayoutPanel.seriesClipRect.x;
                    var centerY = args.chart.chartAxisLayoutPanel.seriesClipRect.width / 2 + args.chart.chartAxisLayoutPanel.seriesClipRect.y;
                    var label = document.getElementById('chartContainer0_AxisLabel_0');
                    var axis = args.chart.axisCollections[0];
                    var vector = helper_1.CoefficientToVector(helper_1.valueToPolarCoefficient(axis.visibleLabels[0].value, axis), args.chart.primaryXAxis.startAngle);
            ...
            it('Checking labels with startAngle for axis for radar axis', function (done) {
                loaded = function (args) {
                    var centerX = args.chart.chartAxisLayoutPanel.seriesClipRect.width / 2 + args.chart.chartAxisLayoutPanel.seriesClipRect.x;
                    var centerY = args.chart.chartAxisLayoutPanel.seriesClipRect.width / 2 + args.chart.chartAxisLayoutPanel.seriesClipRect.y;
                    var label = document.getElementById('chartContainer0_AxisLabel_0');
            ...
            it('Checking negative startAngle for axis for radar axis', function (done) {
                loaded = function (args) {
                    var centerX = args.chart.chartAxisLayoutPanel.seriesClipRect.width / 2 + args.chart.chartAxisLayoutPanel.seriesClipRect.x;
                    var centerY = args.chart.chartAxisLayoutPanel.seriesClipRect.width / 2 + args.chart.chartAxisLayoutPanel.seriesClipRect.y;
                    var label = document.getElementById('chartContainer0_AxisLabel_0');
            ...
            it('Checking negative startAngle for axis', function (done) {
                loaded = function (args) {
                    var centerX = args.chart.chartAxisLayoutPanel.seriesClipRect.width / 2 + args.chart.chartAxisLayoutPanel.seriesClipRect.x;
                    var centerY = args.chart.chartAxisLayoutPanel.seriesClipRect.width / 2 + args.chart.chartAxisLayoutPanel.seriesClipRect.y;
                    var label = document.getElementById('chartContainer0_AxisLabel_0');
            ...
            it('Checking Axis line for y axis', function (done) {
                loaded = function (args) {
                    var element = document.getElementById('chartContainerAxisLine_1');
            ...
            it('Checking Axis line for y axis for radar axis', function (done) {
                loaded = function (args) {
                    var element = document.getElementById('chartContainerAxisLine_1');
                    expect(element !== null).toBe(true);
                    element = document.getElementById('chartContainerAxisLine_0');
            ...
            it('Checking x axis gridLines and tickLines for radar axis', function (done) {
                loaded = function (args) {
                    var element = document.getElementById('chartContainer_MajorGridLine_0_0');
            ...
            it('Checking x axis gridLines and tickLines for polar axis', function (done) {
                loaded = function (args) {
                    var element = document.getElementById('chartContainer_MajorGridLine_0_0');
                    expect(element.getAttribute('d') !== null).toBe(true);
                    element = document.getElementById('chartContainer_MajorTickLine_0_0');
            ...
            it('Checking both axis tickLines inside for polar axis', function (done) {
                loaded = function (args) {
                    var element = document.getElementById('chartContainer_MajorGridLine_0_0');
                    expect(element.getAttribute('d') !== null).toBe(true);
                    element = document.getElementById('chartContainer_MajorTickLine_0_0');
            ...
            it('Checking x axis minorGridLines and TickLines for polar axis', function (done) {
                loaded = function (args) {
                    var element = document.getElementById('chartContainer_MinorGridLine_0_0');
                    expect(element.getAttribute('d') !== null).toBe(true);
            ...
            it('Checking x axis minorGridLines and TickLines for radar axis', function (done) {
                loaded = function (args) {
                    var element = document.getElementById('chartContainer_MinorGridLine_0_0');
                    expect(element.getAttribute('d') !== null).toBe(true);
                    element = document.getElementById('chartContainer_MinorTickLine_0_0');
            ...
            it('Checking startAngle with TickLines for y Axis for radar axis', function (done) {
                loaded = function (args) {
                    var element = document.getElementById('chartContainer_MajorGridLine_1_1');
                    expect(element !== null).toBe(true);
            ...
            it('Checking startAngle with TickLines for y Axis for polar axis', function (done) {
                loaded = function (args) {
                    var element = document.getElementById('chartContainer_MajorGridLine_1_1');
                    expect(element !== null).toBe(true);
                    element = document.getElementById('chartContainer_MajorTickLine_1_1');
            ...
            it('Checking y axis label for log axis for polar axis', function (done) {
                loaded = function (args) {
                    var element = document.getElementById('chartContainer1_AxisLabel_1');
            ...
            it('Checking y axis label for log axis for radar axis', function (done) {
                loaded = function (args) {
                    var element = document.getElementById('chartContainer1_AxisLabel_1');
                    expect(element.textContent === '100').toBe(true);
                    done();
            ...
            it('Checking x axis label for datetime axis for radar axis', function (done) {
                loaded = function (args) {
                    var element = document.getElementById('chartContainer0_AxisLabel_0');
            ...
            it('Checking x axis label for datetime axis for polar axis', function (done) {
                loaded = function (args) {
                    var element = document.getElementById('chartContainer0_AxisLabel_0');
                    expect(element.textContent === '2000').toBe(true);
                    done();
            ...
            it('Checking x axis label category axis and between ticks placement for polar axis', function (done) {
                loaded = function (args) {
            ...
            it('Checking x axis label category axis and between ticks placement for radar axis', function (done) {
                loaded = function (args) {
                    var element = document.getElementById('chartContainer0_AxisLabel_1');
                    expect(element.textContent === 'China').toBe(true);
                    done();
            ...
            it('Checking x axis label category axis and onticks placement for radar axis', function (done) {
                loaded = function (args) {
                    var element = document.getElementById('chartContainer0_AxisLabel_1');
                    expect(element.textContent === 'China').toBe(true);
                    done();
            ...
            it('Checking x axis label category axis and onticks placement for polar axis', function (done) {
                loaded = function (args) {
                    var element = document.getElementById('chartContainer0_AxisLabel_1');
                    expect(element.textContent === 'China').toBe(true);
                    done();
            ...
            it('Checking y axis rangepadding for polar axis', function (done) {
                loaded = function (args) {
                    var element = document.getElementById('chartContainer1_AxisLabel_0');
                    expect(element.textContent === '40');
                    done();
                };
                chartObj.loaded = loaded;
                chartObj.primaryXAxis.valueType = 'Double';
                chartObj.series[0].dataSource = data_spec_2.tool1;
                chartObj.primaryYAxis.rangePadding = 'None';
                chartObj.refresh();
            });
            it('Checking y axis rangepadding for radar axis', function (done) {
                loaded = function (args) {
                    var element = document.getElementById('chartContainer1_AxisLabel_0');
                    expect(element.textContent === '40');
                    done();
            ...
            it('Checking y axis negative values for radar axis', function (done) {
                loaded = function (args) {
                    var element = document.getElementById('chartContainer1_AxisLabel_0');
            ...
            it('Checking y axis negative values for polar axis', function (done) {
                loaded = function (args) {
                    var element = document.getElementById('chartContainer1_AxisLabel_0');
                    expect(element.textContent === '-50');
                    done();
            ...
            it('Checking x axis negative values for double axis for polar axis', function (done) {
                loaded = function (args) {
                    var element = document.getElementById('chartContainer0_AxisLabel_0');
            ...
            it('Checking x axis negative values for double axis for radar axis', function (done) {
                loaded = function (args) {
                    var element = document.getElementById('chartContainer0_AxisLabel_0');
                    expect(element.textContent === '-1000');
                    done();
            ...
            it('Checking majorGridLines visible false for polar axis', function (done) {
                loaded = function (args) {
                    var element = document.getElementById('chartContainer_MajorGridLine_0_0');
                    expect(element === null).toBe(true);
                    done();
            ...
            it('Checking majorGridLines and majorticklines visible false for polar axis', function (done) {
                loaded = function (args) {
                    var element = document.getElementById('chartContainer_MajorGridLine_0_0');
                    expect(element === null).toBe(true);
                    element = document.getElementById('chartContainer_MajorTickLine_0_0');
            ...
            it('Checking y axis majorGridLines and majorticklines visible false for polar axis', function (done) {
                loaded = function (args) {
                    var element = document.getElementById('chartContainer_MajorGridLine_1_1');
                    expect(element === null).toBe(true);
                    element = document.getElementById('chartContainer_MajorTickLine_1_1');
            ...
            it('Checking minorGridLines and minorTicklines visible false', function (done) {
                loaded = function (args) {
                    var element = document.getElementById('chartContainer_MinorGridLine_0_0');
                    expect(element === null).toBe(true);
                    element = document.getElementById('chartContainer_MinorTickLine_0_0');
            ...
            it('Checking with inveresd axis', function (done) {
                loaded = function (args) {
                    var element = document.getElementById('chartContainer0_AxisLabel_0');
                    expect(element !== null).toBe(true);
            ...
            it('Checking with inveresd axis for column ', function (done) {
                loaded = function (args) {
                    var element = document.getElementById('chartContainer0_AxisLabel_0');
                    expect(element !== null).toBe(true);
                    var series = (args.chart.series[0]);
                    var centerX = series.clipRect.x + args.chart.radius;
            ...
            it('Checking with chart title for polar axis', function (done) {
                loaded = function (args) {
                    var centerX = args.chart.chartAxisLayoutPanel.seriesClipRect.width / 2 + args.chart.chartAxisLayoutPanel.seriesClipRect.x;
                    var element = document.getElementById('chartContainer_ChartTitle');
                    done();
                };
                chartObj.loaded = loaded;
            ...
            it('Checking with chart title for radar axis', function (done) {
                loaded = function (args) {
                    var centerX = args.chart.chartAxisLayoutPanel.seriesClipRect.width / 2 + args.chart.chartAxisLayoutPanel.seriesClipRect.x;
                    var element = document.getElementById('chartContainer_ChartTitle');
                    done();
            ...
            it('Checking with coEfficient for primary X axis', function (done) {
                loaded = function (args) {
                    var element = document.getElementById('chartContainerAxisGroup0');
                    expect(element !== null).toBe(true);
                    done();
                };
                chartObj.loaded = loaded;
            ...
            it('Checking with log axis for negetive points', function (done) {
                loaded = function (args) {
                    var element = document.getElementById('chartContainerAxisGroup1');
                    expect(element !== null).toBe(true);
                    done();
                };
                chartObj.loaded = loaded;
            ...
            it('Checking with log axis for negetive points primary x axis', function (done) {
                loaded = function (args) {
                    var element = document.getElementById('chartContainerAxisGroup0');
                    expect(element !== null).toBe(true);
                    done();
        ...
        describe('Polar Axis: Smart Labels', function () {
            var chartObj;
            beforeAll(function () {
            ...
            it('Default Polar Chart', function (done) {
            ...
            it('Default Radar Chart', function (done) {
                chartObj.loaded = function (args) {
                    var chart = document.getElementById('container');
                    expect(chart !== null).toBe(true);
            ...
            it('Check default X axis labels count', function (done) {
                chartObj.loaded = function (args) {
                    var ele = document.getElementById('containerAxisLabels0');
            ...
            it('Check default Y axis labels count', function (done) {
                chartObj.loaded = function (args) {
                    var ele = document.getElementById('containerAxisLabels1');
                    expect(ele.childElementCount == 51).toBe(true);
                    done();
                };
                chartObj.refresh();
            });
            it('Check X axis labels count after hide', function (done) {
                chartObj.loaded = function (args) {
                    var ele = document.getElementById('containerAxisLabels0');
            ...
            it('Check Y axis labels count after hide', function (done) {
                chartObj.loaded = function (args) {
                    var ele = document.getElementById('containerAxisLabels1');
            ...
            it('Check X axis labels hide with label position inside', function (done) {
                chartObj.loaded = function (args) {
                    var ele = document.getElementById('containerAxisLabels0');
            ...
            it('Check Y axis labels count when X axis label inside and Y axis intersect action none', function (done) {
                chartObj.loaded = function (args) {
                    var ele = document.getElementById('containerAxisLabels1');
                    expect(ele.childElementCount == 51).toBe(true);
                    done();
            ...
            it('Check Y axis labels count when X axis label inside and Y axis intersect action hide', function (done) {
                chartObj.loaded = function (args) {
                    var ele = document.getElementById('containerAxisLabels1');
            ...
            it('Check X axis labels with start angle and label position outside', function (done) {
                chartObj.loaded = function (args) {
                    var ele = document.getElementById('containerAxisLabels0');
                    expect(ele.childElementCount == 37 || ele.childElementCount == 38).toBe(true);
                    var anchor = helper_1.getElement("container0_AxisLabel_0").getAttribute("text-anchor");
            ...
            it('Check X axis labels with start angle and label position inside', function (done) {
                chartObj.loaded = function (args) {
                    var ele = document.getElementById('containerAxisLabels0');
        ...
        describe('Customer issue: Polar Radar Category axis gridline not split equally', function () {
            var chartObj;
            beforeAll(function () {
                ele = ej2_base_1.createElement('div', { id: 'container' });
                document.body.appendChild(ele);
            ...
            it('Check last gridline path in radar chart', function (done) {
                chartObj.loaded = function (args) {
                    var path = document.getElementById('container_MajorGridLine_0_14');
            ...
            it('Check last gridline path in polar chart', function (done) {
                chartObj.loaded = function (args) {
                    var path = document.getElementById('container_MajorGridLine_0_14');
                    var d = path.getAttribute("d");
                    expect(d === "M 300 200.125 L 258.06545209888503 105.93846331704785" || d === "M 300 199.625 L 256.9265894982728 102.88053603564855").toBe(true);
        ...
        describe('Polar Axis: Trim Axis Labels', function () {
            var chartObj;
            beforeAll(function () {
                ele = ej2_base_1.createElement('div', { id: 'trimContainer' });
                document.body.appendChild(ele);
                chartObj = new chart_1.Chart({
                    primaryXAxis: {
                        valueType: 'Category',
            ...
            it('Check X axis labels trim with label position outside', function (done) {
                chartObj.loaded = function (args) {
                    var ele = document.getElementById('trimContainer0_AxisLabel_0');
            ...
            it('Check X axis labels without trim for label position outside', function (done) {
                chartObj.loaded = function (args) {
                    var ele = document.getElementById('trimContainer0_AxisLabel_3');
            ...
            it('Check X axis labels trim with label position outside', function (done) {
                chartObj.loaded = function (args) {
                    var ele = document.getElementById('trimContainer0_AxisLabel_4');
                    expect(Math.round(ele.getBoundingClientRect().width) > 34).toBe(true);
                    done();
                };
                chartObj.primaryXAxis.enableTrim = true;
            ...
            it('Check X axis labels without trim for label position inside', function (done) {
                chartObj.loaded = function (args) {
                    var ele = document.getElementById('trimContainer0_AxisLabel_6');
                    expect(ele.innerHTML.indexOf('...') !== -1).toBe(false);
                    done();
                };
                chartObj.primaryXAxis.enableTrim = true;
            ...
            it('Check X axis labels with rtl', function (done) {
                chartObj.loaded = function (args) {
                    var ele = document.getElementById('trimContainer0_AxisLabel_0');
        ...
        describe('Polar Axis: Trim Axis Labels after legend enabled', function () {
            var chartObj;
            beforeAll(function () {
                ele = ej2_base_1.createElement('div', { id: 'Trimcontainer' });
                document.body.appendChild(ele);
            ...
            it('Check X axis labels trim with label position outside - legend position is in right', function (done) {
                chartObj.loaded = function (args) {
                    var ele0 = document.getElementById('Trimcontainer0_AxisLabel_18');
                    expect(ele0.innerHTML.indexOf('...') !== -1).toBe(true);
                    var ele1 = document.getElementById('Trimcontainer0_AxisLabel_20');
            ...
            it('Check X axis labels trim with label position outside - legend position is in Left', function (done) {
                chartObj.loaded = function (args) {
                    var ele = document.getElementById('Trimcontainer0_AxisLabel_58');
                    expect(ele.innerHTML.indexOf('...') !== -1).toBe(true);
                    var ele1 = document.getElementById('Trimcontainer0_AxisLabel_60');
                    expect(ele1.innerHTML.indexOf('...') !== -1).toBe(true);
                    done();
                };
                chartObj.primaryXAxis.enableTrim = true;
            ...
            it('Check X axis labels trim with label position outside - legend position is in right and chart width is small', function (done) {
                chartObj.loaded = function (args) {
                    var ele0 = document.getElementById('Trimcontainer0_AxisLabel_18');
                    expect(ele0.innerHTML.indexOf('...') !== -1).toBe(true);
                    done();
            ...
            it('Check X axis labels trim with label position outside - legend position is in left and chart width is small', function (done) {
                chartObj.loaded = function (args) {
                    var ele0 = document.getElementById('Trimcontainer0_AxisLabel_58');
                    expect(ele0.innerHTML.indexOf('...') !== -1).toBe(true);
                    var ele1 = document.getElementById('Trimcontainer0_AxisLabel_60');
                    expect(ele1.innerHTML.indexOf('...') !== -1).toBe(true);
                    done();
