define(["require", "exports", "@syncfusion/ej2-base", "../../../src/chart/chart", "../../../src/chart/legend/legend", "../../../src/chart/series/line-series", "../../../src/chart/series/spline-series", "../../../src/chart/series/scatter-series", "../../../src/chart/user-interaction/tooltip", "../../../src/chart/user-interaction/crosshair", "../base/events.spec", "../../../src/chart/trend-lines/trend-line", "../../../src/chart/axis/category-axis", "../../common.spec"], function (require, exports, ej2_base_1, chart_1, legend_1, line_series_1, spline_series_1, scatter_series_1, tooltip_1, crosshair_1, events_spec_1, trend_line_1, category_axis_1, common_spec_1) {
    ...
    describe('Chart', function () {
        ...
        var element;
        describe('Logarithmic Trendlines', function () {
            var chartObj;
            var loaded;
            ...
            it('Logarithmic Trendlines without series points and with trendline emptycollection', function (done) {
            ...
            it('Logarithmic Trendlines without series points and with trendline validcollection', function (done) {
                loaded = function (args) {
                    var svg = document.getElementById('containerSeriesGroup0').childNodes.length;
                    expect(svg == 1).toBe(true);
                    var xAxisLabelCollection = document.getElementById('containerAxisLabels0');
            ...
            it('Logarithmic Trendlines with series points and with trendline emptycollection', function (done) {
                loaded = function (args) {
                    var svg = document.getElementById('containerSeriesGroup0').childNodes.length;
            ...
            it('Logarithmic Trendlines with series points and with trendline validcollection', function (done) {
                loaded = function (args) {
            ...
            it('Logarithmic Trendlines with default appearance', function (done) {
                loaded = function (args) {
            ...
            it('Logarithmic Trendlines with custom appearance', function (done) {
                loaded = function (args) {
                    var stroke = document.getElementById('container_Series_0_TrendLine_0').getAttribute('stroke');
            ...
            it('Logaritmic Trendlines with marker', function (done) {
                loaded = function (args) {
            ...
            it('Logarithmic Trendlines with default forecast values', function (done) {
                loaded = function (args) {
                    var path = document.getElementById('container_Series_0_TrendLine_0').getAttribute('d');
                    expect(path !== null).toBe(true);
                    expect(chartObj.visibleSeries[1].points[0].x).toBe(1973);
            ...
            it('Logarithmic Trendlines with custom forwardforecast positive values', function (done) {
                loaded = function (args) {
                    var path = document.getElementById('container_Series_0_TrendLine_0').getAttribute('d');
                    expect(path !== null).toBe(true);
                    expect(chartObj.visibleSeries[1].points[0].x).toBe(1973);
            ...
            it('Logarithmic Trendlines with forwardforecast negative values', function (done) {
                loaded = function (args) {
                    var path = document.getElementById('container_Series_0_TrendLine_0').getAttribute('d');
                    expect(path !== null).toBe(true);
                    expect(chartObj.visibleSeries[1].points[0].x).toBe(1973);
            ...
            it('Logarithmic Trendlines with backward forecast positive values', function (done) {
                loaded = function (args) {
                    var path = document.getElementById('container_Series_0_TrendLine_0').getAttribute('d');
                    expect(path !== null).toBe(true);
            ...
            it('Logarithmic Trendlines with backward forecast negative values', function (done) {
                loaded = function (args) {
                    var path = document.getElementById('container_Series_0_TrendLine_0').getAttribute('d');
                    expect(path !== null).toBe(true);
            ...
            it('Logarithmic Trendlines with enableLegend', function (done) {
                loaded = function (args) {
            ...
            it('Logarithmic Trendlines with disableLegend', function (done) {
                loaded = function (args) {
                    var legendElement = document.getElementById('container_chart_legend_g_1');
                    expect(legendElement === null);
                    done();
            ...
            it('Logarithmic Trendlines with tooltip', function (done) {
                loaded = function (args) {
            ...
            it('Logarithmic Trendlines with trackball', function (done) {
                loaded = function (args) {
        ...
        describe('Logarithmic Trendlines with category data', function () {
            var chartObj;
            var loaded;
            var trigger = new events_spec_1.MouseEvents();
            element = ej2_base_1.createElement('div', { id: 'container' });
            ...
            it('Logarithmic Trendlines with category values', function (done) {
                loaded = function (args) {
                    var svg = document.getElementById('containerSeriesGroup0').childNodes.length;
