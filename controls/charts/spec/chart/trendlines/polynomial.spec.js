define(["require", "exports", "@syncfusion/ej2-base", "../../../src/chart/chart", "../../../src/chart/legend/legend", "../../../src/chart/series/line-series", "../../../src/chart/series/spline-series", "../../../src/chart/series/scatter-series", "../../../src/chart/user-interaction/tooltip", "../../../src/chart/user-interaction/crosshair", "../base/events.spec", "../../../src/chart/trend-lines/trend-line", "../../../src/chart/axis/category-axis", "../../common.spec"], function (require, exports, ej2_base_1, chart_1, legend_1, line_series_1, spline_series_1, scatter_series_1, tooltip_1, crosshair_1, events_spec_1, trend_line_1, category_axis_1, common_spec_1) {
    ...
    describe('Chart', function () {
        ...
        var element;
        describe('Polynomial Trendlines', function () {
            var chartObj;
            var loaded;
            ...
            it('Polynomial Trendlines without series points and with trendline emptycollection', function (done) {
            ...
            it('Polynomial Trendlines without series points and with trendline validcollection', function (done) {
                loaded = function (args) {
                    var svg = document.getElementById('containerSeriesGroup0').childNodes.length;
                    expect(svg == 1).toBe(true);
                    var xAxisLabelCollection = document.getElementById('containerAxisLabels0');
            ...
            it('Polynomial Trendlines with series points and with trendline emptycollection', function (done) {
                loaded = function (args) {
                    var svg = document.getElementById('containerSeriesGroup0').childNodes.length;
            ...
            it('Polynomial Trendlines with series points and with trendline validcollection', function (done) {
                loaded = function (args) {
            ...
            it('Polynomial Trendlines with default appearance', function (done) {
                loaded = function (args) {
            ...
            it('Polynomial Trendlines with custom appearance', function (done) {
                loaded = function (args) {
                    var stroke = document.getElementById('container_Series_0_TrendLine_0').getAttribute('stroke');
            ...
            it('Polynomial Trendlines with marker', function (done) {
                loaded = function (args) {
            ...
            it('Polynomial Trendlines with default forecast values', function (done) {
                loaded = function (args) {
                    var path = document.getElementById('container_Series_0_TrendLine_0').getAttribute('d');
                    expect(path !== null).toBe(true);
                    expect(chartObj.visibleSeries[1].points[0].x).toBe(1973);
            ...
            it('Polynomial Trendlines with custom forwardforecast positive values', function (done) {
                loaded = function (args) {
                    var path = document.getElementById('container_Series_0_TrendLine_0').getAttribute('d');
                    expect(path !== null).toBe(true);
                    expect(chartObj.visibleSeries[1].points[0].x).toBe(1973);
            ...
            it('Polynomial Trendlines with forwardforecast negative values', function (done) {
                loaded = function (args) {
                    var path = document.getElementById('container_Series_0_TrendLine_0').getAttribute('d');
                    expect(path !== null).toBe(true);
                    expect(chartObj.visibleSeries[1].points[0].x).toBe(1973);
            ...
            it('Polynomial Trendlines with backward forecast positive values', function (done) {
                loaded = function (args) {
                    var path = document.getElementById('container_Series_0_TrendLine_0').getAttribute('d');
                    expect(path !== null).toBe(true);
                    expect(chartObj.visibleSeries[1].points[0].x).toBe(1969);
                    expect(Math.round(chartObj.visibleSeries[1].points[0].y)).toBe(-3);
                    done();
                };
                chartObj.loaded = loaded;
            ...
            it('Polynomial Trendlines with backward forecast negative values', function (done) {
                loaded = function (args) {
                    var path = document.getElementById('container_Series_0_TrendLine_0').getAttribute('d');
                    expect(path !== null).toBe(true);
            ...
            it('Polynomial Trendlines with Polynomial Order default values', function (done) {
                loaded = function (args) {
                    var path = document.getElementById('container_Series_0_TrendLine_0').getAttribute('d');
                    expect(path !== null).toBe(true);
                    expect(chartObj.visibleSeries[1].points[0].x).toBe(1977);
            ...
            it('Polynomial Trendlines with Polynomial Order positive values', function (done) {
                loaded = function (args) {
                    var path = document.getElementById('container_Series_0_TrendLine_0').getAttribute('d');
                    expect(path !== null).toBe(true);
                    expect(chartObj.visibleSeries[1].points[0].x).toBe(1977);
            ...
            it('Polynomial Trendlines with Polynomial Order negative values', function (done) {
                loaded = function (args) {
                    var path = document.getElementById('container_Series_0_TrendLine_0').getAttribute('d');
                    expect(path !== null).toBe(true);
                    expect(chartObj.visibleSeries[1].points[0].x).toBe(1977);
            ...
            it('Polynomial Trendlines with Polynomial Order values higher than series points', function (done) {
                loaded = function (args) {
                    var path = document.getElementById('container_Series_0_TrendLine_0').getAttribute('d');
                    expect(path !== null).toBe(true);
                    expect(chartObj.visibleSeries[1].points[0].x).toBe(1977);
            ...
            it('Polynomial Trendlines with enableLegend', function (done) {
                loaded = function (args) {
            ...
            it('Polynomial Trendlines with disableLegend', function (done) {
                loaded = function (args) {
                    var legendElement = document.getElementById('container_chart_legend_g_1');
                    expect(legendElement === null);
                    done();
            ...
            it('Polynomial Trendlines with tooltip', function (done) {
                loaded = function (args) {
            ...
            it('Polynomial Trendlines with trackball', function (done) {
                loaded = function (args) {
        ...
        describe('Polynomial Trendlines with category data', function () {
            var chartObj;
            var loaded;
            var trigger = new events_spec_1.MouseEvents();
            element = ej2_base_1.createElement('div', { id: 'container' });
            ...
            it('Polynomial Trendlines with category values', function (done) {
                loaded = function (args) {
                    var svg = document.getElementById('containerSeriesGroup0').childNodes.length;
